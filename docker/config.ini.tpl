...
org.opentosca.container.engine.plan.hostname={{ .Env.ENGINE_PLAN_HOSTNAME }}
org.opentosca.container.engine.plan.port={{ .Env.ENGINE_PLAN_PORT }}
org.opentosca.container.engine.plan.services.port={{ .Env.ENGINE_PLAN_SERVICES_PORT }}
...
org.opentosca.container.engine.plan.plugin.bpelwso2.url=https\://{{ .Env.ENGINE_PLAN_HOSTNAME }}\:{{ .Env.ENGINE_PLAN_PORT }}
org.opentosca.container.engine.plan.plugin.bpelwso2.services.url=http\://{{ .Env.ENGINE_PLAN_HOSTNAME }}\:{{ .Env.ENGINE_PLAN_SERVICES_PORT }}/services
