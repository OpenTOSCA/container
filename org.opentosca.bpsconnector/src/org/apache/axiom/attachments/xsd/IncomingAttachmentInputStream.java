 ...
 */
                           ...
                           */
                           public  authclient.java.util.xsd.Map getHeaders(){
                            ...
                            /**
                               ...
                               * @param param Headers
                               */
                               public void setHeaders(authclient.java.util.xsd.Map param){
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":IncomingAttachmentInputStream",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                ...
                if (localContentIdTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (localHeaders==null){
                                     ...
                                     localHeaders.serialize(new javax.xml.namespace.QName("http://attachments.axiom.apache.org/xsd","headers"),
                                        xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://attachments.axiom.apache.org/xsd","IncomingAttachmentInputStream"));
                 if (localContentIdTracker){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://attachments.axiom.apache.org/xsd",
                                         ...
                                         elementList.add(localContentLocation==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localContentLocation));
                                    } if (localContentTypeTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://attachments.axiom.apache.org/xsd",
                                                                      "contentType"));
    ...
    public static class Factory{
        ...
        */
        public static IncomingAttachmentInputStream parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            IncomingAttachmentInputStream object =
                new IncomingAttachmentInputStream();
            ...
            try {
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://attachments.axiom.apache.org/xsd","contentId").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://attachments.axiom.apache.org/xsd","contentLocation").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://attachments.axiom.apache.org/xsd","contentType").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://attachments.axiom.apache.org/xsd","headers").equals(reader.getName())){
