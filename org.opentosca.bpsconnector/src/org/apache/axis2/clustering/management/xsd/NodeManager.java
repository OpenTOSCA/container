 ...
 */
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   java.lang.String namespacePrefix = registerPrefix(xmlWriter,"http://management.clustering.axis2.apache.org/xsd");
                ...
                if (localConfigurationContextTracker){
                                    if (localConfigurationContext==null){
                                        ...
                                        writeStartElement(null, "http://management.clustering.axis2.apache.org/xsd", "configurationContext", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localConfigurationContext.serialize(new javax.xml.namespace.QName("http://management.clustering.axis2.apache.org/xsd","configurationContext"),
                                        xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
    ...
    public static class Factory{
        ...
        */
        public static NodeManager parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NodeManager object =
                null;
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"NodeManager".equals(type)){
                                ...
                                return (NodeManager)org.apache.axis2.transaction.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://management.clustering.axis2.apache.org/xsd","configurationContext").equals(reader.getName())){
