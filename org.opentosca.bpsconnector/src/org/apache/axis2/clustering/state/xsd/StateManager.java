 ...
 */
                           ...
                           */
                           public  authclient.java.util.xsd.Map getReplicationExcludePatterns(){
                            ...
                            /**
                               ...
                               */
                               public void setReplicationExcludePatterns(authclient.java.util.xsd.Map param){
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   java.lang.String namespacePrefix = registerPrefix(xmlWriter,"http://state.clustering.axis2.apache.org/xsd");
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":StateManager",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "StateManager",
                ...
                if (localConfigurationContextTracker){
                                    if (localConfigurationContext==null){
                                        ...
                                        writeStartElement(null, "http://state.clustering.axis2.apache.org/xsd", "configurationContext", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localConfigurationContext.serialize(new javax.xml.namespace.QName("http://state.clustering.axis2.apache.org/xsd","configurationContext"),
                                        xmlWriter);
                                    }
                                } if (localReplicationExcludePatternsTracker){
                                    if (localReplicationExcludePatterns==null){

                                        writeStartElement(null, "http://state.clustering.axis2.apache.org/xsd", "replicationExcludePatterns", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localReplicationExcludePatterns.serialize(new javax.xml.namespace.QName("http://state.clustering.axis2.apache.org/xsd","replicationExcludePatterns"),
                                        xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localConfigurationContextTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://state.clustering.axis2.apache.org/xsd",
                                    ...
                                    elementList.add(localReplicationExcludePatterns==null?null:
                                    localReplicationExcludePatterns);
                                }
    ...
    public static class Factory{
        ...
        */
        public static StateManager parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            StateManager object =
                null;
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"StateManager".equals(type)){
                                ...
                                return (StateManager)org.apache.axis2.transaction.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://state.clustering.axis2.apache.org/xsd","configurationContext").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://state.clustering.axis2.apache.org/xsd","replicationExcludePatterns").equals(reader.getName())){
