 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ServiceLifeCycle",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ServiceLifeCycle",
    ...
    public static class Factory{
        ...
        */
        public static ServiceLifeCycle parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ServiceLifeCycle object =
                null;
