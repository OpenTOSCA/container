                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  org.wso2.carbon.bpel.deployer.services.types.xsd.UploadedFileItem[] getFileItems(){
                               ...
                               */
                              protected void validateFileItems(org.wso2.carbon.bpel.deployer.services.types.xsd.UploadedFileItem[] param){
                              ...
                              */
                              public void setFileItems(org.wso2.carbon.bpel.deployer.services.types.xsd.UploadedFileItem[] param){
                             ...
                             */
                             public void addFileItems(org.wso2.carbon.bpel.deployer.services.types.xsd.UploadedFileItem param){
                                   if (localFileItems == null){
                                   localFileItems = new org.wso2.carbon.bpel.deployer.services.types.xsd.UploadedFileItem[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localFileItems);
                               list.add(param);
                               this.localFileItems =
                             (org.wso2.carbon.bpel.deployer.services.types.xsd.UploadedFileItem[])list.toArray(
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        object.setFileItems((org.wso2.carbon.bpel.deployer.services.types.xsd.UploadedFileItem[])
