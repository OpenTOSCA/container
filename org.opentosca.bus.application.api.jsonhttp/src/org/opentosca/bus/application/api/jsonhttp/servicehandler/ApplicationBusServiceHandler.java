...
public class ApplicationBusServiceHandler {
	 ...
	 * 
	 * @param appBus
	 *            - The ApplicationBusService to register.
	 */
	public void bindApplicationBusService(IApplicationBusService appBus) {
	 ...
	 * 
	 * @param appBus
	 *            - The ApplicationBusService to unregister.
	 */
	public void unbindApplicationBusService(IApplicationBusService appBus) {
