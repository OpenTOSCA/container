...
public class ObjectFactory {
    ...
    private final static QName _GetResultResponse_QNAME = new QName("http://opentosca.org/appinvoker/", "getResultResponse");
    private final static QName _InvokeMethodWithNodeInstanceID_QNAME = new QName("http://opentosca.org/appinvoker/", "invokeMethodWithNodeInstanceID");
    private final static QName _InvokeMethodWithNodeInstanceIDResponse_QNAME = new QName("http://opentosca.org/appinvoker/", "invokeMethodWithNodeInstanceIDResponse");
    private final static QName _IsFinishedResponse_QNAME = new QName("http://opentosca.org/appinvoker/", "isFinishedResponse");
    private final static QName _InvokeMethodWithServiceInstanceIDResponse_QNAME = new QName("http://opentosca.org/appinvoker/", "invokeMethodWithServiceInstanceIDResponse");
    private final static QName _ApplicationBusException_QNAME = new QName("http://opentosca.org/appinvoker/", "ApplicationBusException");
    private final static QName _GetResult_QNAME = new QName("http://opentosca.org/appinvoker/", "getResult");
    private final static QName _InvokeMethodWithServiceInstanceID_QNAME = new QName("http://opentosca.org/appinvoker/", "invokeMethodWithServiceInstanceID");
    private final static QName _IsFinished_QNAME = new QName("http://opentosca.org/appinvoker/", "isFinished");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.opentosca.bus.application.api.soaphttp.model
     * 
     */
    ...
    public JAXBElement<InvokeMethodWithNodeInstanceID> createInvokeMethodWithNodeInstanceID(InvokeMethodWithNodeInstanceID value) {
        return new JAXBElement<InvokeMethodWithNodeInstanceID>(_InvokeMethodWithNodeInstanceID_QNAME, InvokeMethodWithNodeInstanceID.class, null, value);
    }
    ...
    public JAXBElement<InvokeMethodWithNodeInstanceIDResponse> createInvokeMethodWithNodeInstanceIDResponse(InvokeMethodWithNodeInstanceIDResponse value) {
        return new JAXBElement<InvokeMethodWithNodeInstanceIDResponse>(_InvokeMethodWithNodeInstanceIDResponse_QNAME, InvokeMethodWithNodeInstanceIDResponse.class, null, value);
    }
    ...
    public JAXBElement<InvokeMethodWithServiceInstanceIDResponse> createInvokeMethodWithServiceInstanceIDResponse(InvokeMethodWithServiceInstanceIDResponse value) {
        return new JAXBElement<InvokeMethodWithServiceInstanceIDResponse>(_InvokeMethodWithServiceInstanceIDResponse_QNAME, InvokeMethodWithServiceInstanceIDResponse.class, null, value);
    }
    ...
    public JAXBElement<ApplicationBusException> createApplicationBusException(ApplicationBusException value) {
        return new JAXBElement<ApplicationBusException>(_ApplicationBusException_QNAME, ApplicationBusException.class, null, value);
    }
    ...
    public JAXBElement<InvokeMethodWithServiceInstanceID> createInvokeMethodWithServiceInstanceID(InvokeMethodWithServiceInstanceID value) {
        return new JAXBElement<InvokeMethodWithServiceInstanceID>(_InvokeMethodWithServiceInstanceID_QNAME, InvokeMethodWithServiceInstanceID.class, null, value);
    }
