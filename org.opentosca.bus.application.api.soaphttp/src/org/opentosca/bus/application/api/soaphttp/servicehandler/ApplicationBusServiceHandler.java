 ...
 * <br>
 *
 * Here the implementation of the IApplicationBusService is binded or unbinded.
 * During the binding the routing endpoint of the Application Bus is handed
 * over.
 *
 *
...
public class ApplicationBusServiceHandler {
	...
	public void bindApplicationBusService(final IApplicationBusService appBus) {
		...
		ApplicationBusServiceHandler.LOG.debug("Bound ApplicationBusService: {} with Endpoint: {}", appBus.toString(), applicationBusRoutingEndpoint);
	...
	public void unbindApplicationBusService(final IApplicationBusService appBus) {
		ApplicationBusServiceHandler.LOG.debug("Unbind ApplicationBusService: {} with Endpoint: {}", appBus.toString(), applicationBusRoutingEndpoint);
