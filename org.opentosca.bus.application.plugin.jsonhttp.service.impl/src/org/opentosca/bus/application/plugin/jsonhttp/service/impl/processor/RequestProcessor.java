...
public class RequestProcessor implements Processor {
	...
	public void process(Exchange exchange) throws Exception {
		...
		String className = exchange.getIn().getHeader(ApplicationBusConstants.CLASS_NAME.toString(), String.class);
		String operationName = exchange.getIn().getHeader(ApplicationBusConstants.OPERATION_NAME.toString(),
				String.class);

		LinkedHashMap<String, Object> params = exchange.getIn().getBody(LinkedHashMap.class);
