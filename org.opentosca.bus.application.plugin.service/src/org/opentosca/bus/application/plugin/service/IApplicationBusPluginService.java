 ...
 * 
 * 
 * The interface specifies two methods. One that returns the supported
 * invocation-types of the plugin and one method that returns the routing
 * endpoint of the bundle.
 * 
 * 
 * 
