...
public class ParameterCheckProcessor implements Processor {
	...
	@Override
	public void process(Exchange exchange) throws ApplicationBusExternalException {
		...
		if (serviceInstanceID != null || nodeInstanceID != null) {
			...
			ParameterCheckProcessor.LOG
					.warn("Can't process request: neither >>ServiceInstanceID<< nor >>NodeInstanceID<< is specified!");
			throw new ApplicationBusExternalException(
