...
public class ApplicationBusPluginServiceHandler {
	...
	private static ConcurrentHashMap<String, String> pluginServices = new ConcurrentHashMap<String, String>();
	 ...
	 */
	public static String getApplicationBusPluginBundleID(String invocationType) {
	 ...
	 * 
	 * @param plugin
	 *            - A AppInvokerPluginService to register.
	 */
	public void bindPluginService(IApplicationBusPluginService plugin) {

		List<String> types = plugin.getSupportedInvocationTypes();
	 ...
	 * 
	 * @param plugin
	 *            - A IApplicationBusPluginService to unregister.
	 */
	public void unbindPluginService(IApplicationBusPluginService plugin) {

		List<String> types = plugin.getSupportedInvocationTypes();

		for (String type : types) {
			Object deletedObject = pluginServices.remove(type);
