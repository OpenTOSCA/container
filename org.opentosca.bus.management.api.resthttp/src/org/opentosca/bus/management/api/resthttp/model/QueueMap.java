...
/**
 * 
 * Map that manages the status of the requests. RequestID is used as
 * <tt>key</tt> of the map. The <tt>value</tt> of the map indicates if the
 * invocation has finished or not.
 * 
...
public class QueueMap {
	...
	private static ConcurrentHashMap<String, Boolean> queue = new ConcurrentHashMap<String, Boolean>();

	/**
	 * Inserts an entry into the queue (if not already existing) and set it to
	 * finished.
	 * 
	 * @param id
	 *            of the request
	...
	/**
	 * Inserts an entry into the queue and set it to notFinished. Only if the id
	 * not already exists.
	 * 
	 * @param id
	 *            of the request
	 */
	public static void notFinished(String id) {
	 ...
	 */
	public static void put(String id, Boolean isFinished) {
	 ...
	 *         <tt>false</tt>
	 */
	public static boolean hasFinished(String id) {
