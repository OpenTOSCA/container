...
/**
 * 
 * Manages the requestIDs needed to correlate the invocation-requests, the
 * isFinished-requests as well as the getResult-requests.
 * 
...
public class RequestID {
	...
	public synchronized static String getNextID() {
		...
		Long id = incrementer.getAndIncrement();
