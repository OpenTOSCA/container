...
public class Route extends RouteBuilder {
	...
	public static String ENDPOINT = "http://" + Settings.OPENTOSCA_CONTAINER_HOSTNAME + ":8081/invoker";
	...
	public void configure() throws Exception {
		...
		final String url = "http://" + localhost.getHostAddress() + ":8081/invoker";
		ENDPOINT = url;

		// CXF Endpoints
		final String INVOKE_ENDPOINT = "cxf:" + url + "?wsdlURL=" + wsdlURL.toString() + "&serviceName={http://siserver.org/wsdl}InvokerService&portName=" + Route.PORT.toString() + "&dataFormat=PAYLOAD&loggingFeatureEnabled=true";
