...
public class Route extends RouteBuilder {
	...
	public void configure() throws Exception {
		...
		// CXF Endpoints
		final String INVOKE_ENDPOINT = "cxf:" + Route.ENDPOINT + "?wsdlURL=" + wsdlURL.toString()
		...
		final String CALLBACK_ENDPOINT = "cxf:${header[ReplyTo]}?wsdlURL=" + wsdlURL.toString()
				+ "&serviceName={http://siserver.org/wsdl}InvokerService&portName={http://siserver.org/wsdl}CallbackPort&dataFormat=PAYLOAD&loggingFeatureEnabled=true";
		...
		this.from("direct-vm:" + Activator.apiID).process(responseProcessor).marshal(responseJaxb).to("stream:out")
