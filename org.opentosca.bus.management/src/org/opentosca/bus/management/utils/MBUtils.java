...
public class MBUtils {
	 ...
	 */
	public static String getOperatingSystemNodeTemplateID(CSARID csarID, QName serviceTemplateID, String nodeTemplateID) {
	 ...
	 */
	public static String getInterfaceForOperatingSystemNodeType(CSARID csarID, QName nodeType) {
		if (ServiceHandler.toscaEngineService.doesInterfaceOfNodeTypeContainOperation(csarID, nodeType, Interfaces.OPENTOSCA_DECLARATIVE_INTERFACE_OPERATINGSYSTEM, Interfaces.OPENTOSCA_DECLARATIVE_INTERFACE_OPERATINGSYSTEM_RUNSCRIPT) && ServiceHandler.toscaEngineService.doesInterfaceOfNodeTypeContainOperation(csarID, nodeType, Interfaces.OPENTOSCA_DECLARATIVE_INTERFACE_OPERATINGSYSTEM, Interfaces.OPENTOSCA_DECLARATIVE_INTERFACE_OPERATINGSYSTEM_TRANSFERFILE) && ServiceHandler.toscaEngineService.doesInterfaceOfNodeTypeContainOperation(csarID, nodeType, Interfaces.OPENTOSCA_DECLARATIVE_INTERFACE_OPERATINGSYSTEM, Interfaces.OPENTOSCA_DECLARATIVE_INTERFACE_OPERATINGSYSTEM_INSTALLPACKAGE)) {
	...
	public static String getOperatingSystemIA(CSARID csarID, QName serviceTemplateID, String osNodeTemplateID) {
		...
		QName osNodeType = ServiceHandler.toscaEngineService.getNodeTypeOfNodeTemplate(csarID, serviceTemplateID, osNodeTemplateID);
		
		List<QName> osNodeTypeImpls = ServiceHandler.toscaEngineService.getNodeTypeImplementationsOfNodeType(csarID, osNodeType);
		
		for (QName osNodeTypeImpl : osNodeTypeImpls) {
			
			MBUtils.LOG.debug("NodeTypeImpl: {} ", osNodeTypeImpl);
			
			List<String> osIANames = ServiceHandler.toscaEngineService.getImplementationArtifactNamesOfNodeTypeImplementation(csarID, osNodeTypeImpl);
			
			for (String osIAName : osIANames) {
				
				MBUtils.LOG.debug("IA: {} ", osIAName);
				
				String osIAInterface = ServiceHandler.toscaEngineService.getInterfaceOfAImplementationArtifactOfANodeTypeImplementation(csarID, osNodeTypeImpl, osIAName);
	 ...
	 *         null.
	 */
	public static String searchProperty(String property, CSARID csarID, QName serviceTemplateID, String nodeTemplateID, URI serviceInstanceID) {
	 ...
	 *         null.
	 */
	public static String getInstanceDataPropertyValue(String property, CSARID csarID, QName serviceTemplateID, String nodeTemplateID, URI serviceInstanceID) {
		
		HashMap<String, String> propertiesMap = getInstanceDataProperties(csarID, serviceTemplateID, nodeTemplateID, serviceInstanceID);
	 ...
	 */
	public static HashMap<String, String> getInstanceDataProperties(CSARID csarID, QName serviceTemplateID, String nodeTemplateID, URI serviceInstanceID) {
