 ...
 */
@Component(AppBusGetResultProcessor.BEAN_NAME)
@NonNullByDefault
public class AppBusGetResultProcessor implements Processor {

    public static final String BEAN_NAME = "getResultProcessor";

    private static final Logger LOG = LoggerFactory.getLogger(AppBusGetResultProcessor.class);
