...
/**
 * This class takes Artifacts with relative references and converts the
 * references to absolute ones which could be accessed from outside of the
 * container
 *
...
public class ArtifactAbsolutizer {
	...
	/**
	 * This method takes
	 * <code>org.opentosca.portability.service.model.Artifacts</code> and
	 * converts the contained references to absolute ones (before they are like
	 * <code>"/IA/ApacheWebserver/start.sh"</code> afterwards they will be
	 * external links f.ex.
	...
	private static String absolutizeReference(final UriInfo uriInfo, final String csarID, final String relativeReference) {
