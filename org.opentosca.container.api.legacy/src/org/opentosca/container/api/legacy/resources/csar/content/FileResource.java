...
public class FileResource {
	...
	/**
	 * Retrieval of image files. Is handled separately from the generic file
	 * retrieval as the corresponding mime type has to be set.
	 *
	 * TODO Can we set the supported media types depending on the
	 * imageMediaTypes map in ResourceConstants?
	 * (String[])ResourceConstants.imageMediaTypes.values().toArray(new
