...
public class BoundsInterfaceOperationResource {
	...
	private References getReferences() {
		...
		refs.getReference().add(new Reference(Utilities.buildURI(this.uriInfo.getAbsolutePath().toString(), "NodeOperation"), XLinkConstants.SIMPLE, "NodeOperation"));
		refs.getReference().add(new Reference(Utilities.buildURI(this.uriInfo.getAbsolutePath().toString(), "RelationshipOperation"), XLinkConstants.SIMPLE, "RelationshipOperation"));
		refs.getReference().add(new Reference(Utilities.buildURI(this.uriInfo.getAbsolutePath().toString(), "Plan"), XLinkConstants.SIMPLE, "Plan"));
