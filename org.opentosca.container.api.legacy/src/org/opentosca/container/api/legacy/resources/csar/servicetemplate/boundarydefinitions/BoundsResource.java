...
public class BoundsResource {
    ...
    private References getReferences() {
        ...
        refs.getReference()
            .add(new Reference(Utilities.buildURI(this.uriInfo, "Interfaces"), XLinkConstants.SIMPLE, "Interfaces"));
    ...
    /**
     * Returns the Boundary Definitions Properties. TODO not yet implemented yet, thus, just returns
     * itself.
     *
     * @param uriInfo
     * @return Response
