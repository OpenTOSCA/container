...
public class ServiceTemplateInstancesResource {
	...
	private String postManagementPlanJSON(final UriInfo uriInfo, final String json) throws UnsupportedEncodingException {
		...
		final String url = uriInfo.getBaseUri().toString() + "CSARs/" + this.csarId.getFileName() + "/ServiceTemplates/" + URLEncoder.encode(this.serviceTemplateID.toString(), "UTF-8") + "/Instances?BuildPlanCorrelationId=" + correlationID;
