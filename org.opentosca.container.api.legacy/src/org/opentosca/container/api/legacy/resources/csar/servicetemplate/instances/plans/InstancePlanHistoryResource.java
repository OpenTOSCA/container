...
public class InstancePlanHistoryResource {
	...
	public References getReferences() {
		...
		InstancePlanHistoryResource.LOG.debug("Access the plan history at " + this.uriInfo.getAbsolutePath().toString());
	...
	public Response getPlanJSON(@PathParam("CorrelationID") final String correlationID) {
		...
		InstancePlanHistoryResource.LOG.debug("Return plan for correlation " + correlationID);
		final PlanInvocationEvent event = CSARInstanceManagementHandler.csarInstanceManagement.getPlanFromHistory(correlationID);
