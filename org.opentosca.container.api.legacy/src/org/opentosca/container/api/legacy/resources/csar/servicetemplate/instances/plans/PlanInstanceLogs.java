...
public class PlanInstanceLogs {
	...
	public PlanInstanceLogs(final CSARID csarID, final QName serviceTemplateID, final int serviceTemplateInstanceId, final String correlationID) {
		this.csarID = csarID;
	...
	public Response getReferencesXML(@Context final UriInfo uriInfo) {
		...
		final Map<String, String> msgs = PlanInvocationEngineHandler.planInvocationEngine.getPlanLogHandler().getLogsOfPlanInstance(this.correlationID);
	...
	public Response postLogEntry(@Context final UriInfo uriInfo, final String xml) throws URISyntaxException, UnsupportedEncodingException {
