...
public class PlanInstanceState {
  ...
  public PlanInstanceState(final CSARID csarID, final QName serviceTemplateID,
  ...
  public Response getReferencesXML(@Context final UriInfo uriInfo) {
    ...
    builder.append("<PlanInstance planName=\"").append(pi.getTemplateId().toString())
        .append("\" correlationID=\"").append(this.correlationID).append("\"><State>");
  ...
  public Boolean hasFinished() {
    ...
    if ((null != CSARInstanceManagementHandler.csarInstanceManagement
        .getFinishedCorrelations(this.csarID))
    ...
    // not finished
    else if ((null != CSARInstanceManagementHandler.csarInstanceManagement
        .getActiveCorrelations(this.csarID))
