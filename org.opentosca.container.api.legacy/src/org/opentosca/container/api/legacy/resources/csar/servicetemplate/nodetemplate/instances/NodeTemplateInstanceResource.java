...
public class NodeTemplateInstanceResource {
	...
	public NodeTemplateInstanceResource(final CSARID csarId, final QName serviceTemplateID, final int serviceTemplateInstanceId, final QName nodeTemplateID, final int id) {
		this.csarId = csarId;
	...
	public References getRefs(final UriInfo uriInfo) throws UnsupportedEncodingException {
		...
		final List<NodeInstance> nodeInstances = service.getNodeInstances(IdConverter.nodeInstanceIDtoURI(this.nodeTemplateInstanceId), null, null, null);
