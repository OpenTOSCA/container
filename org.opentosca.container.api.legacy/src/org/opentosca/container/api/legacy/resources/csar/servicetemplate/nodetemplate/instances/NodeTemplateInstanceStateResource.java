...
public class NodeTemplateInstanceStateResource {
	...
	public String getState() {
		...
		try {
			final QName state = service.getState(IdConverter.nodeInstanceIDtoURI(this.nodeInstanceID));
			if (state != null) {
	...
	public Response setState(@Context final UriInfo uriInfo, final String state) {
		...
		try {
			service.setState(IdConverter.nodeInstanceIDtoURI(this.nodeInstanceID), stateQName);
