...
public class RelationshipTemplateInstanceListResource {
	...
	public Response doGetXML(@Context final UriInfo uriInfo, @QueryParam("relationInstanceID") final String relationInstanceID, @QueryParam("relationshipTemplateID") final String relationshipTemplateID, @QueryParam("serviceInstanceID") final String serviceInstanceID, @QueryParam("relationshipTemplateName") final String relationshipTemplateName) {
		
		final RelationInstanceList idr = this.getRefs(uriInfo, relationInstanceID, relationshipTemplateID, serviceInstanceID, relationshipTemplateName);
	...
	public Response doGetJSON(@Context final UriInfo uriInfo, @QueryParam("relationInstanceID") final String relationInstanceID, @QueryParam("relationshipTemplateID") final String relationshipTemplateID, @QueryParam("serviceInstanceID") final String serviceInstanceID, @QueryParam("relationshipTemplateName") final String relationshipTemplateName) {
	...
	public RelationInstanceList getRefs(final UriInfo uriInfo, final String relationInstanceID, final String relationshipTemplateID, final String serviceInstanceID, final String relationshipTemplateName) {
		...
		try {
			...
			final List<RelationInstance> result = service.getRelationInstances(relationInstanceIdURI, relationshipTemplateIDQName, relationshipTemplateName, serviceInstanceIdURI);
	...
	@POST
	@Produces(MediaType.APPLICATION_XML)
	public Response createRelationInstance(@QueryParam("relationshipTemplateID") final String relationshipTemplateID, @QueryParam("serviceInstanceID") final String serviceInstanceID, @Context final UriInfo uriInfo) {
		...
		try {
			...
			final NodeInstance nodeInstance = service.createNodeInstance(relationshipTemplateIDQName, serviceInstanceIdURI);
