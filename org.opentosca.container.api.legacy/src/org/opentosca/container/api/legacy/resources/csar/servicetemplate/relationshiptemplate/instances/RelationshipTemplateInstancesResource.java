...
public class RelationshipTemplateInstancesResource {
  ...
  public RelationshipTemplateInstancesResource(final CSARID csarId, final QName serviceTemplateID,
  ...
  public References getRefs(final UriInfo uriInfo) {
    ...
    final URI serviceInstanceIDtoURI =
        IdConverter.serviceInstanceIDtoURI(this.serviceTemplateInstanceId);
    ...
    try {
      ...
      for (final RelationInstance relationInstance : relationInstances) {
        ...
        if (this.relatioshipTemplateID.toString().equalsIgnoreCase(relationId.toString())
            || this.relatioshipTemplateID.toString().equalsIgnoreCase(relationId.getLocalPart())) {
          final Reference ref =
              new Reference(Utilities.buildURI(uriInfo, String.valueOf(relationInstanceId)),
                  XLinkConstants.SIMPLE, String.valueOf(relationInstanceId));
          ...
          this.log.debug("Skipped node instance {} of node template id {}", relationInstanceId,
              relationId);
        }
      ...
      final ServiceInstanceEntry sie =
          new ServiceInstanceEntry(serviceInstance, serviceInstanceLinks, ril);
  ...
  public Response createRelationInstance(@Context final UriInfo uriInfo,
    ...
    try {
      final RelationInstance relationInstance = service.createRelationInstance(this.csarId,
          this.serviceTemplateID, this.serviceTemplateInstanceId, this.relatioshipTemplateID,
      ...
      final SimpleXLink response = new SimpleXLink(Utilities.encode(
          uriInfo.getAbsolutePathBuilder().path(String.valueOf(relationInstance.getId())).build()),
          "simple");
  ...
  public Object getRelationInstance(
    ...
    return new RelationshipTemplateInstanceResource(this.csarId, this.serviceTemplateID,
        this.serviceTemplateInstanceId, this.relatioshipTemplateID, relationshipTemplateInstanceId);
  }
}
