...
/**
 * Resource of the default storage provider of the Core File Service (regardless if it's available
 * or not).<br />
 * <br />
...
public class DefaultStorageProviderResource {
    ...
    /**
     * @return {@link StorageProviderJaxb} containing the default storage provider that will be showed
     *         on this resource.
     */
    @GET
