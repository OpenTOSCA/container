...
public class JaxbFactory {
    ...
    /**
     *
     * @return {@link StorageProvidersJaxb} that contains all available storage providers.
    ...
    /**
     *
     * @return {@link StorageProvidersJaxb} that contains the active storage provider if it's set
     *         (otherwise not storage provider is contained).
     * @see #createStorageProvidersJaxb(Set)
     */
    ...
    /**
     *
     * @return {@link StorageProvidersJaxb} that contains the ready storage providers.
     * @see #createStorageProvidersJaxb(Set)
     */
    ...
    /**
     *
     * @return {@link StorageProviderJaxb} that contains the default storage provider.
    ...
    /**
     *
     * @return {@link StorageProvidersJaxb} that contains the default storage provider.
     * @see #createStorageProvidersJaxb(Set)
     */
    ...
    /**
     *
     * Builds a {@link StorageProviderJaxb} of the storage provider {@code storageProviderID}.<br />
     * Necessary data (e.g. is storage provider ready) will be fetched from the {@link ICoreFileService}
     * and {@link ICoreCredentialsService}.
     *
     * @param storageProviderID of storage provider.
     * @return {@link StorageProviderJaxb} of the storage provider {@code storageProviderID}.
     */
     ...
     * @return {@link StorageProvidersJaxb} containing the storage providers {@code storageProviderIDs}.
     */
