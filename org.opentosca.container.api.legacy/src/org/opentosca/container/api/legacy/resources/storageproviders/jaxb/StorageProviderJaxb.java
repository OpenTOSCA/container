 ...
 * {@link AvailableStorageProviderResource} and {@link DefaultStorageProviderResource}.<br />
 * <br />
...
public class StorageProviderJaxb {
    ...
    /**
     * We use the wrapper class {@link Boolean}, because we doesn't want to show a XML element (with
     * value {@code false}) in case boolean was not set.
     */
    ...
    /**
     * @return {@code true} if this storage provider is active, otherwise {@code false}.
     */
    ...
    /**
     * @return {@code true} if this storage provider is ready, otherwise {@code false}.
     */
    ...
    /**
     * @return {@code true} if this storage provider is the default storage provider, otherwise
     *         {@code false}.
     */
    ...
    /**
     *
     * @return {@code true} if this storage provider needs credentials, otherwise {@code false}.
     */
     ...
     */
    public void setNeedsCredentials(final boolean needsCredentials) {
    ...
    /**
     * Sets {@code credentialsIdentityName} as the credentials identity name of this storage provider.
     */
    public void setCredentialsIdentityName(final String credentialsIdentityName) {
    ...
    /**
     * Sets {@code credentialsKeyName} as the credentials key name of this storage provider.
     */
    public void setCredentialsKeyName(final String credentialsKeyName) {
        this.credentialsKeyName = credentialsKeyName;
    }

    /**
     * @return {@code true} if this storage provider has credentials set, otherwise {@code false}.
     */
     ...
     */
    public void setHasCredentials(final boolean hasCredentials) {
