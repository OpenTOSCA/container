...
public class BoundaryDefinitionController {
	...
	@ApiOperation(value = "Gets boundary definitions for a given service template", response = ResourceSupport.class, responseContainer = "List")
	...
	@Path("/properties")
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	@ApiOperation(value = "Gets properties of a service tempate", response = PropertiesDTO.class, responseContainer = "List")
	...
	@Path("/interfaces")
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	@ApiOperation(value = "Gets interfaces of a service tempate", response = InterfaceDTO.class, responseContainer = "List")
	...
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	@ApiOperation(value = "Gets an interface of a service template specified by its name", response = InterfaceDTO.class)
