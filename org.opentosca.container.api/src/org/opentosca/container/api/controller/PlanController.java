...
public class PlanController {
	...
	public Response invokePlan(@PathParam("plan") final String plan, @Context final UriInfo uriInfo, final List<TParameter> parameters) {
		...
		/*
		 * Add paramater "OpenTOSCAContainerAPIServiceInstanceID" as a callback
		 * for the plan engine
		 */
		if (this.serviceTemplateInstanceId != null) {
			...
			url = url.replace("{servicetemplateid}", UriComponent.encode(this.serviceTemplate.toString(), UriComponent.Type.PATH_SEGMENT));
