...
public class ServiceTemplateInstanceController {
	...
	public PlanController getManagementPlans(@PathParam("csar") final String csar, @PathParam("servicetemplate") final String servicetemplate, @PathParam("id") final Integer id) {
		...
		return new PlanController(csarContent.getCSARID(), QName.valueOf(servicetemplate), id, this.planService, this.instanceService, PlanTypes.TERMINATION);
	}
