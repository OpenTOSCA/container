...
public class PlanService {
    ...
    private static final List<PlanTypes> ALL_PLAN_TYPES = Lists.newArrayList(PlanTypes.APPLICATION, PlanTypes.BUILD,
        PlanTypes.OTHERMANAGEMENT, PlanTypes.TERMINATION);
    ...
    public String invokePlan(final CSARID csarId, final QName serviceTemplate, final TPlan plan,
        ...
        try {
            // Trigger plan
            final String correlationId = this.controlService.invokePlanInvocation(csarId, serviceTemplate, -1,
            ...
            if (verifyDeployment && Boolean.valueOf(Settings.OPENTOSCA_DEPLOYMENT_VERIFICATION)) {
                this.verificationService.runAfterPlan(csarId, correlationId);
            }
