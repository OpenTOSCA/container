...
public abstract class SOAPFaultNode implements org.apache.axis2.databinding.ADBBean {
  /*
   * This type was generated from the piece of schema that had name = SOAPFaultNode Namespace URI =
   ...
   *
   */
  private static final long serialVersionUID = 2136134559253236607L;
   ...
   */
  public void setNodeValue(final java.lang.String param) {
    this.localNodeValueTracker = true;
  ...
  public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
    ...
    if (serializeType) {
      ...
      if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
        ...
        writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "SOAPFaultNode", xmlWriter);
      }


    }
    if (this.localNodeValueTracker) {
      namespace = "http://soap.axiom.apache.org/xsd";
      writeStartElement(null, namespace, "nodeValue", xmlWriter);


      if (this.localNodeValue == null) {
        ...
        xmlWriter.writeCharacters(this.localNodeValue);
  ...
  public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
    ...
    if (this.localNodeValueTracker) {
      elementList.add(new javax.xml.namespace.QName("http://soap.axiom.apache.org/xsd", "nodeValue"));

      elementList.add(this.localNodeValue == null ? null
        : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localNodeValue));
    }
  ...
  public static class Factory {
     ...
     * outer element
     */
    public static SOAPFaultNode parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
      final SOAPFaultNode object = null;
      ...
      try {
        ...
        if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap.axiom.apache.org/xsd",
          "nodeValue").equals(reader.getName())) {
          ...
          if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
            ...
            object.setNodeValue(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
