...
public abstract class SOAPFaultRole implements org.apache.axis2.databinding.ADBBean {
  /*
   * This type was generated from the piece of schema that had name = SOAPFaultRole Namespace URI =
   ...
   *
   */
  private static final long serialVersionUID = -6157760988913751566L;
   ...
   */
  public void setRoleValue(final java.lang.String param) {
    this.localRoleValueTracker = true;
  ...
  public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
    ...
    if (serializeType) {
      ...
      if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
        ...
        writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "SOAPFaultRole", xmlWriter);
      }


    }
    if (this.localRoleValueTracker) {
      namespace = "http://soap.axiom.apache.org/xsd";
      writeStartElement(null, namespace, "roleValue", xmlWriter);


      if (this.localRoleValue == null) {
        ...
        xmlWriter.writeCharacters(this.localRoleValue);
  ...
  public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
    ...
    if (this.localRoleValueTracker) {
      elementList.add(new javax.xml.namespace.QName("http://soap.axiom.apache.org/xsd", "roleValue"));

      elementList.add(this.localRoleValue == null ? null
        : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localRoleValue));
    }
  ...
  public static class Factory {
     ...
     * outer element
     */
    public static SOAPFaultRole parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
      final SOAPFaultRole object = null;
      ...
      try {
        ...
        if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap.axiom.apache.org/xsd",
          "roleValue").equals(reader.getName())) {
          ...
          if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
            ...
            object.setRoleValue(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
