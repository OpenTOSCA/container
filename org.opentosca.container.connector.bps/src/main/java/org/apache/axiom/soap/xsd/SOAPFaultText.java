...
public abstract class SOAPFaultText implements org.apache.axis2.databinding.ADBBean {
  /*
   * This type was generated from the piece of schema that had name = SOAPFaultText Namespace URI =
   ...
   *
   */
  private static final long serialVersionUID = 228684773023599404L;
   ...
   * @param param Lang
   */
  public void setLang(final java.lang.String param) {
    this.localLangTracker = true;
  ...
  public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
    ...
    if (serializeType) {
      ...
      if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
        ...
        writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "SOAPFaultText", xmlWriter);
      }


    }
    if (this.localLangTracker) {
      ...
      if (this.localLang == null) {
        ...
        xmlWriter.writeCharacters(this.localLang);
  ...
  public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
    ...
    if (this.localLangTracker) {
      elementList.add(new javax.xml.namespace.QName("http://soap.axiom.apache.org/xsd", "lang"));

      elementList.add(this.localLang == null ? null
        : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localLang));
    }
  ...
  public static class Factory {
     ...
     * outer element
     */
    public static SOAPFaultText parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
      final SOAPFaultText object = null;
