...
public abstract class NodeManager implements org.apache.axis2.databinding.ADBBean {
  /*
   * This type was generated from the piece of schema that had name = NodeManager Namespace URI =
   * http://management.clustering.axis2.apache.org/xsd Namespace Prefix = ns11
   */
   ...
   *
   */
  private static final long serialVersionUID = 3966966973286939094L;
  ...
  public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
    ...
    if (serializeType) {
      ...
      final java.lang.String namespacePrefix =
        registerPrefix(xmlWriter, "http://management.clustering.axis2.apache.org/xsd");
      if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
        writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
          namespacePrefix + ":NodeManager", xmlWriter);
      } else {
        writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "NodeManager", xmlWriter);
      }
    ...
    if (this.localConfigurationContextTracker) {
      if (this.localConfigurationContext == null) {
        ...
        writeStartElement(null, "http://management.clustering.axis2.apache.org/xsd", "configurationContext",
          xmlWriter);
        ...
        this.localConfigurationContext.serialize(new javax.xml.namespace.QName(
          "http://management.clustering.axis2.apache.org/xsd", "configurationContext"), xmlWriter);
      }
    }
    xmlWriter.writeEndElement();
  ...
  private static java.lang.String generatePrefix(final java.lang.String namespace) {
    if (namespace.equals("http://management.clustering.axis2.apache.org/xsd")) {
      return "ns11";
    }
  ...
  public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
    ...
    if (this.localConfigurationContextTracker) {
      elementList.add(new javax.xml.namespace.QName("http://management.clustering.axis2.apache.org/xsd",
  ...
  public static class Factory {
     ...
     * outer element
     */
    public static NodeManager parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
      final NodeManager object = null;
      ...
      try {
        ...
        if (reader.isStartElement()
          && new javax.xml.namespace.QName("http://management.clustering.axis2.apache.org/xsd",
