...
public class SessionContext implements org.apache.axis2.databinding.ADBBean {
  /*
   * This type was generated from the piece of schema that had name = SessionContext Namespace URI =
   ...
   *
   */
  private static final long serialVersionUID = -3004075048862541922L;
   ...
   */
  public void setCookieID(final java.lang.String param) {
    this.localCookieIDTracker = true;
  ...
  public long getLastTouchedTime() {
    return this.localLastTouchedTime;
  }
   ...
   */
  public void setLastTouchedTime(final long param) {

    // setting primitive attribute tracker to true
    this.localLastTouchedTimeTracker = param != java.lang.Long.MIN_VALUE;
  ...
  protected authclient.java.util.xsd.Iterator localServiceGroupContext;
   ...
   */
  public authclient.java.util.xsd.Iterator getServiceGroupContext() {
   ...
   */
  public void setServiceGroupContext(final authclient.java.util.xsd.Iterator param) {
  ...
  public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
    ...
    if (serializeType) {
      ...
      if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
        ...
        writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "SessionContext", xmlWriter);
      }


    }
    if (this.localCookieIDTracker) {
      namespace = "http://context.axis2.apache.org/xsd";
      writeStartElement(null, namespace, "cookieID", xmlWriter);


      if (this.localCookieID == null) {
        ...
        xmlWriter.writeCharacters(this.localCookieID);

      }

      xmlWriter.writeEndElement();
    }
    if (this.localLastTouchedTimeTracker) {
      namespace = "http://context.axis2.apache.org/xsd";
      writeStartElement(null, namespace, "lastTouchedTime", xmlWriter);

      if (this.localLastTouchedTime == java.lang.Long.MIN_VALUE) {

        throw new org.apache.axis2.databinding.ADBException("lastTouchedTime cannot be null!!");

      } else {
        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localLastTouchedTime));
      }
  ...
  public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
    ...
    if (this.localCookieIDTracker) {
      elementList.add(new javax.xml.namespace.QName("http://context.axis2.apache.org/xsd", "cookieID"));

      elementList.add(this.localCookieID == null ? null
        : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localCookieID));
    }
    if (this.localLastTouchedTimeTracker) {
      elementList.add(new javax.xml.namespace.QName("http://context.axis2.apache.org/xsd", "lastTouchedTime"));

      elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localLastTouchedTime));
    }
    if (this.localRootContextTracker) {
  ...
  public static class Factory {
     ...
     * outer element
     */
    public static SessionContext parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
      final SessionContext object = new SessionContext();
      ...
      try {
        ...
        if (reader.isStartElement() && new javax.xml.namespace.QName("http://context.axis2.apache.org/xsd",
          "cookieID").equals(reader.getName())) {
          ...
          if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
            ...
            object.setCookieID(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
        ...
        if (reader.isStartElement() && new javax.xml.namespace.QName("http://context.axis2.apache.org/xsd",
          ...
          object.setLastTouchedTime(org.apache.axis2.databinding.utils.ConverterUtil.convertToLong(content));
        ...
        if (reader.isStartElement() && new javax.xml.namespace.QName("http://context.axis2.apache.org/xsd",
          ...
          if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
            ...
            object.setServiceGroupContext(authclient.java.util.xsd.Iterator.Factory.parse(reader));
