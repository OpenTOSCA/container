...
public class HandlerDescription implements org.apache.axis2.databinding.ADBBean {
  ...
  public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
    ...
    if (this.localHandlerTracker) {
      if (this.localHandler == null) {
        ...
        this.localHandler.serialize(new javax.xml.namespace.QName("http://description.axis2.apache.org/xsd",
          "handler"), xmlWriter);
      }
    }
    ...
    if (this.localRulesTracker) {
      if (this.localRules == null) {
        ...
        this.localRules.serialize(new javax.xml.namespace.QName("http://description.axis2.apache.org/xsd",
          "rules"), xmlWriter);
      }
    }
    xmlWriter.writeEndElement();
  ...
  public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
    ...
    if (this.localClassNameTracker) {
      ...
      elementList.add(this.localClassName == null ? null
        : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localClassName));
    }
    if (this.localHandlerTracker) {
  ...
  public static class Factory {
     ...
     * outer element
     */
    public static HandlerDescription parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
