...
public abstract class Element implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = Element Namespace URI =
     ...
     *
     */
    private static final long serialVersionUID = -3521058482554042391L;
     ...
     * @param param TagName
     */
    public void setTagName(final java.lang.String param) {
        this.localTagNameTracker = true;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":Element",
                               xmlWriter);
            } else {
        ...
        if (this.localSchemaTypeInfoTracker) {
            if (this.localSchemaTypeInfo == null) {
                ...
                this.localSchemaTypeInfo.serialize(new javax.xml.namespace.QName("http://dom.w3c.org/xsd",
                    "schemaTypeInfo"), xmlWriter);
            }
        }
        if (this.localTagNameTracker) {
            namespace = "http://dom.w3c.org/xsd";
            writeStartElement(null, namespace, "tagName", xmlWriter);


            if (this.localTagName == null) {
                // write the nil attribute
                ...
                xmlWriter.writeCharacters(this.localTagName);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
        ...
        if (this.localTagNameTracker) {
            ...
            elementList.add(this.localTagName == null ? null
                                                      : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localTagName));
        }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static Element parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            final Element object = null;
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Element".equals(type)) {
                            ...
                            return (Element) org.apache.axis2.transaction.xsd.ExtensionMapper.getTypeObject(nsUri, type,
                                                                                                            reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://dom.w3c.org/xsd",
                    "schemaTypeInfo").equals(reader.getName())) {
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://dom.w3c.org/xsd", "tagName").equals(reader.getName())) {
