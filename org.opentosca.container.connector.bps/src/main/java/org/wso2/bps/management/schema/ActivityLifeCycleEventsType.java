...
public class ActivityLifeCycleEventsType implements org.apache.axis2.databinding.ADBBean {
  ...
  public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
    ...
    if (this.localEventInfoListTracker) {
      ...
      this.localEventInfoList.serialize(new javax.xml.namespace.QName("http://wso2.org/bps/management/schema",
        "eventInfoList"), xmlWriter);
    }
    xmlWriter.writeEndElement();
  ...
  public static class Factory {
     ...
     * outer element
     */
    public static ActivityLifeCycleEventsType parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
      ...
      try {
        ...
        if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
          ...
          if (fullTypeName != null) {
            ...
            if (!"ActivityLifeCycleEventsType".equals(type)) {
              ...
              return (ActivityLifeCycleEventsType) org.wso2.bps.management.wsdl.instancemanagement.ExtensionMapper.getTypeObject(nsUri,
                type,
                reader);
            }
        ...
        if (reader.isStartElement() && new javax.xml.namespace.QName("http://wso2.org/bps/management/schema",
          "eventInfoList").equals(reader.getName())) {
