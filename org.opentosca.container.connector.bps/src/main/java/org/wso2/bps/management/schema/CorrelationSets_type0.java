...
public class CorrelationSets_type0 implements org.apache.axis2.databinding.ADBBean {
  /*
   * This type was generated from the piece of schema that had name = correlationSets_type0 Namespace
   ...
   *
   */
  private static final long serialVersionUID = 2066255255412278230L;
  /**
   * field for CorrelationSet This was an Array!
   */


  protected org.wso2.bps.management.schema.CorrelationSet_type0[] localCorrelationSet;


  /**
   * Auto generated getter method
   *
   * @return org.wso2.bps.management.schema.CorrelationSet_type0[]
   */
  public org.wso2.bps.management.schema.CorrelationSet_type0[] getCorrelationSet() {
   ...
   */
  protected void validateCorrelationSet(final org.wso2.bps.management.schema.CorrelationSet_type0[] param) {
   ...
   */
  public void setCorrelationSet(final org.wso2.bps.management.schema.CorrelationSet_type0[] param) {
   ...
   *
   * @param param org.wso2.bps.management.schema.CorrelationSet_type0
   */
  public void addCorrelationSet(final org.wso2.bps.management.schema.CorrelationSet_type0 param) {
    if (this.localCorrelationSet == null) {
      this.localCorrelationSet = new org.wso2.bps.management.schema.CorrelationSet_type0[] {};
    }
    ...
    public static CorrelationSets_type0 parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
      ...
      try {
        ...
        if (reader.isStartElement() && new javax.xml.namespace.QName("http://wso2.org/bps/management/schema",
          ...
          list1.add(org.wso2.bps.management.schema.CorrelationSet_type0.Factory.parse(reader));
