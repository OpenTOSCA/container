...
public class DeleteInstance implements org.apache.axis2.databinding.ADBBean {
     ...
     *
     */
    private static final long serialVersionUID = 5541691965963290234L;



    public static final javax.xml.namespace.QName MY_QNAME =
        new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "deleteInstance", "ns1");
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                               namespacePrefix + ":deleteInstance", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "deleteInstance", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static DeleteInstance parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            final DeleteInstance object = new DeleteInstance();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"deleteInstance".equals(type)) {
                            ...
                            return (DeleteInstance) org.wso2.bps.management.wsdl.instancemanagement.ExtensionMapper.getTypeObject(nsUri,
                                                                                                                                  type,
                                                                                                                                  reader);
                        }
