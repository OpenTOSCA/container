...
public class EventInfoE implements org.apache.axis2.databinding.ADBBean {

  /**
   *
   */
  private static final long serialVersionUID = 5911724862343461102L;


  public static final javax.xml.namespace.QName MY_QNAME =
    new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "event-info", "ns1");
  ...
  public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
    ...
    this.localEventInfo.serialize(MY_QNAME, xmlWriter);
  ...
  public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
    ...
    // We can safely assume an element has only one type associated with it
    return this.localEventInfo.getPullParser(MY_QNAME);
  ...
  public static class Factory {
     ...
     * outer element
     */
    public static EventInfoE parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
      final EventInfoE object = new EventInfoE();
        ...
        while (!reader.isEndElement()) {
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
              ...
              object.setEventInfo(org.wso2.bps.management.schema.EventInfo.Factory.parse(reader));
