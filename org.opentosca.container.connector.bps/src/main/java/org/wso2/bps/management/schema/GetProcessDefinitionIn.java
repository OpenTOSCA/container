...
public class GetProcessDefinitionIn implements org.apache.axis2.databinding.ADBBean {

  /**
   *
   */
  private static final long serialVersionUID = -6898179968715471155L;
  ...
  public javax.xml.namespace.QName getGetProcessDefinitionIn() {
    return this.localGetProcessDefinitionIn;
  }
   ...
   */
  public void setGetProcessDefinitionIn(final javax.xml.namespace.QName param) {
  ...
  public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
    ...
    final java.lang.String localName = "getProcessDefinitionIn";
    ...
    if (this.localGetProcessDefinitionIn == null) {

      throw new org.apache.axis2.databinding.ADBException("getProcessDefinitionIn cannot be null !!");

    } else {

      writeQName(this.localGetProcessDefinitionIn, xmlWriter);
        ...
        while (!reader.isEndElement()) {
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
              ...
              "getProcessDefinitionIn").equals(reader.getName())) {
