...
public class ProcessManagementException extends java.lang.Exception {
  ...
  public ProcessManagementException(final java.lang.String s) {
    super(s);
  }

  public ProcessManagementException(final java.lang.String s, final java.lang.Throwable ex) {
    super(s, ex);
  }

  public ProcessManagementException(final java.lang.Throwable cause) {
    super(cause);
  }


  public void setFaultMessage(final org.wso2.bps.management.schema.ProcessManagementException msg) {
