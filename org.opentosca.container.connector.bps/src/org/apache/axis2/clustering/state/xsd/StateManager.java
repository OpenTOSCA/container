...
public abstract class StateManager implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = StateManager Namespace URI =
     * http://state.clustering.axis2.apache.org/xsd Namespace Prefix = ns12
     */
     ...
     *
     */
    private static final long serialVersionUID = 6996746525145150706L;
    ...
    protected authclient.java.util.xsd.Map localReplicationExcludePatterns;
     ...
     */
    public authclient.java.util.xsd.Map getReplicationExcludePatterns() {
     ...
     */
    public void setReplicationExcludePatterns(final authclient.java.util.xsd.Map param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                ...
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "StateManager", xmlWriter);
            }
        ...
        if (this.localConfigurationContextTracker) {
            if (this.localConfigurationContext == null) {
                ...
                writeStartElement(null, "http://state.clustering.axis2.apache.org/xsd", "configurationContext",
                    xmlWriter);
                ...
                this.localConfigurationContext.serialize(new javax.xml.namespace.QName(
                    "http://state.clustering.axis2.apache.org/xsd", "configurationContext"), xmlWriter);
            }
        }
        if (this.localReplicationExcludePatternsTracker) {
            if (this.localReplicationExcludePatterns == null) {

                writeStartElement(null, "http://state.clustering.axis2.apache.org/xsd", "replicationExcludePatterns",
                    xmlWriter);
                ...
                this.localReplicationExcludePatterns.serialize(new javax.xml.namespace.QName(
                    "http://state.clustering.axis2.apache.org/xsd", "replicationExcludePatterns"), xmlWriter);
            }
        }
        xmlWriter.writeEndElement();
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        if (this.localConfigurationContextTracker) {
            elementList.add(
                new javax.xml.namespace.QName("http://state.clustering.axis2.apache.org/xsd", "configurationContext"));


            elementList.add(this.localConfigurationContext == null ? null : this.localConfigurationContext);
        }
        if (this.localReplicationExcludePatternsTracker) {
            elementList.add(new javax.xml.namespace.QName("http://state.clustering.axis2.apache.org/xsd",
                "replicationExcludePatterns"));


            elementList.add(this.localReplicationExcludePatterns == null ? null : this.localReplicationExcludePatterns);
        }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static StateManager parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            final StateManager object = null;
            ...
            try {
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://state.clustering.axis2.apache.org/xsd",
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://state.clustering.axis2.apache.org/xsd",
                        "replicationExcludePatterns").equals(reader.getName())) {
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        object.setReplicationExcludePatterns(authclient.java.util.xsd.Map.Factory.parse(reader));
