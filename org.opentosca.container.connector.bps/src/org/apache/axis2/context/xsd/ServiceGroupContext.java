...
public class ServiceGroupContext implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = ServiceGroupContext Namespace
     ...
     *
     */
    private static final long serialVersionUID = -8984790554851921943L;
     ...
     */
    public void setDescription(final org.apache.axis2.description.xsd.AxisServiceGroup param) {
    ...
    protected authclient.java.util.xsd.Iterator localServiceContexts;
     ...
     */
    public authclient.java.util.xsd.Iterator getServiceContexts() {
        return this.localServiceContexts;
    }
     ...
     */
    public void setServiceContexts(final authclient.java.util.xsd.Iterator param) {
        this.localServiceContextsTracker = true;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                ...
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ServiceGroupContext",
                    xmlWriter);
            }
        ...
        if (this.localDescriptionTracker) {
            if (this.localDescription == null) {
                ...
                writeStartElement(null, "http://context.axis2.apache.org/xsd", "description", xmlWriter);
                ...
                this.localDescription.serialize(
                    new javax.xml.namespace.QName("http://context.axis2.apache.org/xsd", "description"), xmlWriter);
            }
        }
        ...
        if (this.localServiceContextsTracker) {
            if (this.localServiceContexts == null) {

                writeStartElement(null, "http://context.axis2.apache.org/xsd", "serviceContexts", xmlWriter);

                // write the nil attribute
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
                xmlWriter.writeEndElement();
            } else {
                this.localServiceContexts.serialize(
                    new javax.xml.namespace.QName("http://context.axis2.apache.org/xsd", "serviceContexts"), xmlWriter);
            }
        }
        xmlWriter.writeEndElement();
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        if (this.localDescriptionTracker) {
            elementList.add(new javax.xml.namespace.QName("http://context.axis2.apache.org/xsd", "description"));


            elementList.add(this.localDescription == null ? null : this.localDescription);
        }
        if (this.localIdTracker) {
            elementList.add(new javax.xml.namespace.QName("http://context.axis2.apache.org/xsd", "id"));
        ...
        if (this.localServiceContextsTracker) {
            elementList.add(new javax.xml.namespace.QName("http://context.axis2.apache.org/xsd", "serviceContexts"));


            elementList.add(this.localServiceContexts == null ? null : this.localServiceContexts);
        }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static ServiceGroupContext parse(final javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            final ServiceGroupContext object = new ServiceGroupContext();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ServiceGroupContext".equals(type)) {
                            ...
                            return (ServiceGroupContext) org.apache.axis2.transaction.xsd.ExtensionMapper.getTypeObject(
                                nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://context.axis2.apache.org/xsd", "description").equals(
                        reader.getName())) {
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        object.setDescription(org.apache.axis2.description.xsd.AxisServiceGroup.Factory.parse(reader));
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://context.axis2.apache.org/xsd", "id").equals(
                        reader.getName())) {
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://context.axis2.apache.org/xsd", "serviceContexts").equals(
                        reader.getName())) {
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        object.setServiceContexts(authclient.java.util.xsd.Iterator.Factory.parse(reader));
