 ...
 */
                           ...
                           */
                           public  authclient.java.util.xsd.Map getComplexSchemaMap(){
                            ...
                            /**
                               ...
                               */
                               public void setComplexSchemaMap(authclient.java.util.xsd.Map param){
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   java.lang.String namespacePrefix = registerPrefix(xmlWriter,"http://java2wsdl.description.axis2.apache.org/xsd");
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":TypeTable",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "TypeTable",
                ...
                if (localComplexSchemaMapTracker){
                                    if (localComplexSchemaMap==null){
                                        ...
                                        writeStartElement(null, "http://java2wsdl.description.axis2.apache.org/xsd", "complexSchemaMap", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localComplexSchemaMap.serialize(new javax.xml.namespace.QName("http://java2wsdl.description.axis2.apache.org/xsd","complexSchemaMap"),
                                        xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localComplexSchemaMapTracker){
                            elementList.add(new javax.xml.namespace.QName("http://java2wsdl.description.axis2.apache.org/xsd",
                                    ...
                                    elementList.add(localComplexSchemaMap==null?null:
                                    localComplexSchemaMap);
                                }
    ...
    public static class Factory{
        ...
        */
        public static TypeTable parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TypeTable object =
                new TypeTable();
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"TypeTable".equals(type)){
                                ...
                                return (TypeTable)org.apache.axis2.transaction.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://java2wsdl.description.axis2.apache.org/xsd","complexSchemaMap").equals(reader.getName())){
