...
public class AxisServiceGroup implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (this.localAxisDescriptionTracker) {
            if (this.localAxisDescription == null) {
                ...
                this.localAxisDescription.serialize(
                    new javax.xml.namespace.QName("http://description.axis2.apache.org/xsd", "axisDescription"),
                    xmlWriter);
            }
        }
        if (this.localFoundWebResourcesTracker) {
            ...
            if (false) {
                ...
                xmlWriter.writeCharacters(
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localFoundWebResources));
            }
        ...
        if (this.localServiceGroupClassLoaderTracker) {
            ...
            if (this.localServiceGroupClassLoader != null) {
                if (this.localServiceGroupClassLoader instanceof org.apache.axis2.databinding.ADBBean) {
                    ((org.apache.axis2.databinding.ADBBean) this.localServiceGroupClassLoader).serialize(
        ...
        if (this.localServicesTracker) {
            if (this.localServices == null) {
                ...
                this.localServices.serialize(
                    new javax.xml.namespace.QName("http://description.axis2.apache.org/xsd", "services"), xmlWriter);
            }
        }
        xmlWriter.writeEndElement();
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        if (this.localFoundWebResourcesTracker) {
            elementList.add(
                new javax.xml.namespace.QName("http://description.axis2.apache.org/xsd", "foundWebResources"));
        ...
        if (this.localServiceGroupNameTracker) {
            elementList.add(
                new javax.xml.namespace.QName("http://description.axis2.apache.org/xsd", "serviceGroupName"));
    ...
    public static class Factory {
        ...
        public static AxisServiceGroup parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://description.axis2.apache.org/xsd", "services").equals(
                        reader.getName())) {
