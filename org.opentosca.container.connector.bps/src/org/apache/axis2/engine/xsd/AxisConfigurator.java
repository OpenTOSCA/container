...
public abstract class AxisConfigurator implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = AxisConfigurator Namespace URI =
     ...
     *
     */
    private static final long serialVersionUID = -7199236038319636857L;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                ...
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "AxisConfigurator",
                    xmlWriter);
            }
        ...
        if (this.localAxisConfigurationTracker) {
            if (this.localAxisConfiguration == null) {
                ...
                writeStartElement(null, "http://engine.axis2.apache.org/xsd", "axisConfiguration", xmlWriter);
                ...
                this.localAxisConfiguration.serialize(
                    new javax.xml.namespace.QName("http://engine.axis2.apache.org/xsd", "axisConfiguration"),
                    xmlWriter);
            }
        }
        xmlWriter.writeEndElement();
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        if (this.localAxisConfigurationTracker) {
            elementList.add(new javax.xml.namespace.QName("http://engine.axis2.apache.org/xsd", "axisConfiguration"));
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static AxisConfigurator parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            final AxisConfigurator object = null;
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AxisConfigurator".equals(type)) {
                            ...
                            return (AxisConfigurator) org.apache.axis2.transaction.xsd.ExtensionMapper.getTypeObject(
                                nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://engine.axis2.apache.org/xsd", "axisConfiguration").equals(
                        reader.getName())) {
