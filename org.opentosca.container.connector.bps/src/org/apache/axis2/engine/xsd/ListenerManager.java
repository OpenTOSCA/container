...
public class ListenerManager implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (this.localConfigctxTracker) {
            if (this.localConfigctx == null) {
                ...
                this.localConfigctx.serialize(
                    new javax.xml.namespace.QName("http://engine.axis2.apache.org/xsd", "configctx"), xmlWriter);
            }
        }
        if (this.localShutdownHookRequiredTracker) {
            ...
            if (false) {
                ...
                xmlWriter.writeCharacters(
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localShutdownHookRequired));
            }
        ...
        if (this.localStoppedTracker) {
            ...
            if (false) {
                ...
                xmlWriter.writeCharacters(
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localStopped));
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        if (this.localShutdownHookRequiredTracker) {
            elementList.add(
                new javax.xml.namespace.QName("http://engine.axis2.apache.org/xsd", "shutdownHookRequired"));
        ...
        public static ListenerManager parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://engine.axis2.apache.org/xsd", "configctx").equals(
                        reader.getName())) {
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://engine.axis2.apache.org/xsd", "stopped").equals(
                        reader.getName())) {
