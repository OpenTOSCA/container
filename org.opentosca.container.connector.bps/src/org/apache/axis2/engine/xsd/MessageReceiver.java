...
public abstract class MessageReceiver implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = MessageReceiver Namespace URI =
     ...
     *
     */
    private static final long serialVersionUID = -2923692097481142991L;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                ...
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "MessageReceiver",
                    xmlWriter);
            }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static MessageReceiver parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            final MessageReceiver object = null;
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"MessageReceiver".equals(type)) {
                            ...
                            return (MessageReceiver) org.apache.axis2.transaction.xsd.ExtensionMapper.getTypeObject(
                                nsUri, type, reader);
                        }
