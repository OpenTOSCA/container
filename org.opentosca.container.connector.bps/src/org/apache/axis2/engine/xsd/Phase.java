    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (this.localHandlerCountTracker) {
            ...
            if (this.localHandlerCount == java.lang.Integer.MIN_VALUE) {
                ...
                xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localHandlerCount));
            }
        ...
        if (this.localHandlersTracker) {
            ...
            if (this.localHandlers != null) {
                if (this.localHandlers instanceof org.apache.axis2.databinding.ADBBean) {
                    ((org.apache.axis2.databinding.ADBBean) this.localHandlers).serialize(new javax.xml.namespace.QName(
                        "http://engine.axis2.apache.org/xsd", "handlers"), xmlWriter, true);
                } else {
        ...
        if (this.localPhaseFirstTracker) {
            if (this.localPhaseFirst == null) {
                ...
                this.localPhaseFirst.serialize(new javax.xml.namespace.QName("http://engine.axis2.apache.org/xsd",
        ...
        if (this.localPhaseLastTracker) {
            if (this.localPhaseLast == null) {
                ...
                this.localPhaseLast.serialize(new javax.xml.namespace.QName("http://engine.axis2.apache.org/xsd",
                    "phaseLast"), xmlWriter);
            }
        }
    ...
    public static class Factory {
        ...
        public static Phase parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://engine.axis2.apache.org/xsd",
                    "handlers").equals(reader.getName())) {
