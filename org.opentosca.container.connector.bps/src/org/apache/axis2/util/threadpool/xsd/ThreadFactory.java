...
public abstract class ThreadFactory implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = ThreadFactory Namespace URI =
     * http://threadpool.util.axis2.apache.org/xsd Namespace Prefix = ns9
     */
     ...
     *
     */
    private static final long serialVersionUID = -4409945647067632365L;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            final java.lang.String namespacePrefix =
                registerPrefix(xmlWriter, "http://threadpool.util.axis2.apache.org/xsd");
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                               namespacePrefix + ":ThreadFactory", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ThreadFactory", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static ThreadFactory parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            final ThreadFactory object = null;
