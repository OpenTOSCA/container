...
public class XmlSchemaAnnotation extends org.apache.ws.commons.schema.xsd.XmlSchemaObject
    ...
    /*
     * This type was generated from the piece of schema that had name = XmlSchemaAnnotation Namespace
     * URI = http://schema.commons.ws.apache.org/xsd Namespace Prefix = ns22
     */
     ...
     *
     */
    private static final long serialVersionUID = -5211386334370859883L;
     ...
     * @param param Items
     */
    public void setItems(final org.apache.ws.commons.schema.xsd.XmlSchemaObjectCollection param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                namespacePrefix + ":XmlSchemaAnnotation", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "XmlSchemaAnnotation",
                xmlWriter);
        }
        ...
        if (this.localItemsTracker) {
            if (this.localItems == null) {
                ...
                writeStartElement(null, "http://schema.commons.ws.apache.org/xsd", "items", xmlWriter);

                // write the nil attribute
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
                xmlWriter.writeEndElement();
            } else {
                this.localItems.serialize(
                    new javax.xml.namespace.QName("http://schema.commons.ws.apache.org/xsd", "items"), xmlWriter);
            }
        }
        xmlWriter.writeEndElement();
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        attribList.add(new javax.xml.namespace.QName("http://schema.commons.ws.apache.org/xsd", "XmlSchemaAnnotation"));
        if (this.localLineNumberTracker) {
        ...
        if (this.localItemsTracker) {
            elementList.add(new javax.xml.namespace.QName("http://schema.commons.ws.apache.org/xsd", "items"));


            elementList.add(this.localItems == null ? null : this.localItems);
        }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static XmlSchemaAnnotation parse(final javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            final XmlSchemaAnnotation object = new XmlSchemaAnnotation();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"XmlSchemaAnnotation".equals(type)) {
                            ...
                            return (XmlSchemaAnnotation) org.apache.axis2.transaction.xsd.ExtensionMapper.getTypeObject(
                                nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://schema.commons.ws.apache.org/xsd", "items").equals(
                        reader.getName())) {
