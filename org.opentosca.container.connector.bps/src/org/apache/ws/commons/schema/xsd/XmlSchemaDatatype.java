 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":XmlSchemaDatatype",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "XmlSchemaDatatype",
    ...
    public static class Factory{
        ...
        */
        public static XmlSchemaDatatype parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            XmlSchemaDatatype object =
                null;
