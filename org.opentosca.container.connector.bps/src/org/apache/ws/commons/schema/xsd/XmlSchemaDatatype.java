...
public abstract class XmlSchemaDatatype implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static XmlSchemaDatatype parse(final javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"XmlSchemaDatatype".equals(type)) {
                            ...
                            return (XmlSchemaDatatype) org.apache.axis2.transaction.xsd.ExtensionMapper.getTypeObject(
                                nsUri, type, reader);
                        }
