...
public class ActivateProcessIn implements org.apache.axis2.databinding.ADBBean {

    /**
     *
     */
    private static final long serialVersionUID = 3860406421382871502L;



    public static final javax.xml.namespace.QName MY_QNAME =
        new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "activateProcessIn", "ns1");
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                               namespacePrefix + ":activateProcessIn", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "activateProcessIn",
                               xmlWriter);
            }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static ActivateProcessIn parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            final ActivateProcessIn object = new ActivateProcessIn();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"activateProcessIn".equals(type)) {
                            ...
                            return (ActivateProcessIn) org.wso2.bps.management.wsdl.instancemanagement.ExtensionMapper.getTypeObject(nsUri,
                                                                                                                                     type,
                                                                                                                                     reader);
                        }
