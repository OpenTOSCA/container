...
public class ActivitiesWithEvents_type0 implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = activitiesWithEvents_type0
     ...
     *
     */
    private static final long serialVersionUID = -4522449658986485460L;

    /**
     * field for ActivityInfoWithEvents This was an Array!
     */


    protected org.wso2.bps.management.schema.ActivityInfoWithEventsType[] localActivityInfoWithEvents;
     ...
     *
     * @return org.wso2.bps.management.schema.ActivityInfoWithEventsType[]
     */
    public org.wso2.bps.management.schema.ActivityInfoWithEventsType[] getActivityInfoWithEvents() {
        return this.localActivityInfoWithEvents;
    }
     ...
     */
    public void setActivityInfoWithEvents(final org.wso2.bps.management.schema.ActivityInfoWithEventsType[] param) {

        validateActivityInfoWithEvents(param);

        this.localActivityInfoWithEventsTracker = param != null;
     ...
     *
     * @param param org.wso2.bps.management.schema.ActivityInfoWithEventsType
     */
    public void addActivityInfoWithEvents(final org.wso2.bps.management.schema.ActivityInfoWithEventsType param) {
        if (this.localActivityInfoWithEvents == null) {
            this.localActivityInfoWithEvents = new org.wso2.bps.management.schema.ActivityInfoWithEventsType[] {};
        }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (this.localActivityInfoWithEventsTracker) {
            if (this.localActivityInfoWithEvents != null) {
                for (final ActivityInfoWithEventsType localActivityInfoWithEvent : this.localActivityInfoWithEvents) {
                    if (localActivityInfoWithEvent != null) {
                        localActivityInfoWithEvent.serialize(new javax.xml.namespace.QName(
                            "http://wso2.org/bps/management/schema", "activityInfoWithEvents"), xmlWriter);
                    } else {
            ...
            if (this.localActivityInfoWithEvents != null) {
                for (final ActivityInfoWithEventsType localActivityInfoWithEvent : this.localActivityInfoWithEvents) {
                    ...
                    if (localActivityInfoWithEvent != null) {
                        ...
                        elementList.add(localActivityInfoWithEvent);
                    } else {
