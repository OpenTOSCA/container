...
public class ActivityLifeCycleEventsType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = ActivityLifeCycleEventsType
     ...
     *
     */
    private static final long serialVersionUID = 2174799164037704730L;
    ...
    public org.wso2.bps.management.schema.ActivityLifeCycleEventsListType getEventInfoList() {
        return this.localEventInfoList;
    }
     ...
     */
    public void setEventInfoList(final org.wso2.bps.management.schema.ActivityLifeCycleEventsListType param) {
        this.localEventInfoListTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        xmlWriter.writeEndElement();
        if (this.localEventInfoListTracker) {
            if (this.localEventInfoList == null) {
                throw new org.apache.axis2.databinding.ADBException("eventInfoList cannot be null!!");
            }
            this.localEventInfoList.serialize(
                new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "eventInfoList"), xmlWriter);
        }
        xmlWriter.writeEndElement();
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        if (this.localEventInfoListTracker) {
            elementList.add(new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "eventInfoList"));


            if (this.localEventInfoList == null) {
                throw new org.apache.axis2.databinding.ADBException("eventInfoList cannot be null!!");
            }
            elementList.add(this.localEventInfoList);
        }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static ActivityLifeCycleEventsType parse(final javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            final ActivityLifeCycleEventsType object = new ActivityLifeCycleEventsType();
            ...
            try {
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "eventInfoList").equals(
                        reader.getName())) {

                    object.setEventInfoList(
                        org.wso2.bps.management.schema.ActivityLifeCycleEventsListType.Factory.parse(reader));
