...
public class CorrelationSet_type0 implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = correlationSet_type0 Namespace
     ...
     *
     */
    private static final long serialVersionUID = 6256187781417288738L;
    ...
    public void addCorrelationProperty(final org.wso2.bps.management.schema.CorrelationPropertyType param) {
        ...
        list.add(param);
        this.localCorrelationProperty = (org.wso2.bps.management.schema.CorrelationPropertyType[]) list.toArray(
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    namespacePrefix + ":correlationSet_type0", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "correlationSet_type0",
                    xmlWriter);
            }
        ...
        if (this.localCsetid != null) {
            ...
            writeAttribute("", "csetid",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localCsetid), xmlWriter);
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static CorrelationSet_type0 parse(final javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            final CorrelationSet_type0 object = new CorrelationSet_type0();
            ...
            try {
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://wso2.org/bps/management/schema",
                    ...
                    object.setCorrelationProperty(
                        (org.wso2.bps.management.schema.CorrelationPropertyType[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                            org.wso2.bps.management.schema.CorrelationPropertyType.class, list1));
