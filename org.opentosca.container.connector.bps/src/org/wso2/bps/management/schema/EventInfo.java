...
public class EventInfo implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (this.localScopeIdTracker) {
            ...
            if (this.localScopeId == java.lang.Long.MIN_VALUE) {
                ...
                xmlWriter.writeCharacters(
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localScopeId));
            }
        ...
        if (this.localActivityIdTracker) {
            ...
            if (this.localActivityId == java.lang.Long.MIN_VALUE) {
                ...
                xmlWriter.writeCharacters(
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localActivityId));
            }
        ...
        if (this.localIsRecoveryRequiredTracker) {
            ...
            if (false) {
                ...
                xmlWriter.writeCharacters(
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localIsRecoveryRequired));
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        if (this.localActivityNameTracker) {
            ...
            if (this.localActivityName != null) {
                elementList.add(
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localActivityName));
            } else {
                throw new org.apache.axis2.databinding.ADBException("activity-name cannot be null!!");
            }
        }
        if (this.localActivityTypeTracker) {
            ...
            if (this.localActivityType != null) {
                elementList.add(
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localActivityType));
            } else {
                throw new org.apache.axis2.databinding.ADBException("activity-type cannot be null!!");
            }
        }
        if (this.localIsRecoveryRequiredTracker) {
            elementList.add(
                new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "isRecoveryRequired"));
    ...
    public static class Factory {
        ...
        public static EventInfo parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"EventInfo".equals(type)) {
                            ...
                            return (EventInfo) org.wso2.bps.management.wsdl.instancemanagement.ExtensionMapper.getTypeObject(
                                nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "type").equals(
                        reader.getName())) {
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "line-number").equals(
                        reader.getName())) {
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "timestamp").equals(
                        reader.getName())) {
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "scope-id").equals(
                        reader.getName())) {
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "scope-name").equals(
                        reader.getName())) {
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "activity-id").equals(
                        reader.getName())) {
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "activity-name").equals(
                        reader.getName())) {
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "activity-type").equals(
                        reader.getName())) {
