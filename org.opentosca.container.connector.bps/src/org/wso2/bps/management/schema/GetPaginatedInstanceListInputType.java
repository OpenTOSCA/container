...
public class GetPaginatedInstanceListInputType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
     * getPaginatedInstanceListInputType Namespace URI = http://wso2.org/bps/management/schema Namespace
     * Prefix = ns1
     */
     ...
     *
     */
    private static final long serialVersionUID = 8266818994325465298L;
    /**
     * field for Filter
     */
     ...
     * @param param Order
     */
    public void setOrder(final java.lang.String param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    namespacePrefix + ":getPaginatedInstanceListInputType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getPaginatedInstanceListInputType", xmlWriter);
            }
        ...
        if (this.localOrder == null) {
            ...
            xmlWriter.writeCharacters(this.localOrder);
        ...
        if (this.localLimit == java.lang.Integer.MIN_VALUE) {
            ...
            xmlWriter.writeCharacters(
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localLimit));
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        elementList.add(new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "order"));

        if (this.localOrder != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localOrder));
        } else {
            throw new org.apache.axis2.databinding.ADBException("order cannot be null!!");
        }

        elementList.add(new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "limit"));
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static GetPaginatedInstanceListInputType parse(final javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            final GetPaginatedInstanceListInputType object = new GetPaginatedInstanceListInputType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getPaginatedInstanceListInputType".equals(type)) {
                            ...
                            return (GetPaginatedInstanceListInputType) org.wso2.bps.management.wsdl.instancemanagement.ExtensionMapper.getTypeObject(
                                nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "filter").equals(
                        reader.getName())) {
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "order").equals(
                        reader.getName())) {

                    final java.lang.String content = reader.getElementText();

                    object.setOrder(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "limit").equals(
                        reader.getName())) {
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "page").equals(
                        reader.getName())) {
