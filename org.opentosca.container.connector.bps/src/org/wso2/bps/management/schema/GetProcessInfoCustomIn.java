...
public class GetProcessInfoCustomIn implements org.apache.axis2.databinding.ADBBean {

    /**
     *
     */
    private static final long serialVersionUID = 6956458444760455200L;



    public static final javax.xml.namespace.QName MY_QNAME =
        new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "getProcessInfoCustomIn", "ns1");
     ...
     * @param param Pid
     */
    public void setPid(final javax.xml.namespace.QName param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                               namespacePrefix + ":getProcessInfoCustomIn", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getProcessInfoCustomIn",
                               xmlWriter);
            }
        ...
        if (this.localPid == null) {
            ...
            writeQName(this.localPid, xmlWriter);
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static GetProcessInfoCustomIn parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            final GetProcessInfoCustomIn object = new GetProcessInfoCustomIn();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getProcessInfoCustomIn".equals(type)) {
                            ...
                            return (GetProcessInfoCustomIn) org.wso2.bps.management.wsdl.instancemanagement.ExtensionMapper.getTypeObject(nsUri,
                                                                                                                                          type,
                                                                                                                                          reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://wso2.org/bps/management/schema",
                    ...
                    object.setPid(org.apache.axis2.databinding.utils.ConverterUtil.convertToQName(content,
                                                                                                  namespaceuri));
