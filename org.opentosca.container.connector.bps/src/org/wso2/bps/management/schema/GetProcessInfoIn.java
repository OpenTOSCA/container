...
public class GetProcessInfoIn implements org.apache.axis2.databinding.ADBBean {

    /**
     *
     */
    private static final long serialVersionUID = -8933225489862263420L;



    public static final javax.xml.namespace.QName MY_QNAME =
        new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "getProcessInfoIn", "ns1");
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                               namespacePrefix + ":getProcessInfoIn", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getProcessInfoIn",
                               xmlWriter);
            }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static GetProcessInfoIn parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            final GetProcessInfoIn object = new GetProcessInfoIn();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getProcessInfoIn".equals(type)) {
                            ...
                            return (GetProcessInfoIn) org.wso2.bps.management.wsdl.instancemanagement.ExtensionMapper.getTypeObject(nsUri,
                                                                                                                                    type,
                                                                                                                                    reader);
                        }
