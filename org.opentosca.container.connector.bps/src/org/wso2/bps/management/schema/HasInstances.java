...
public class HasInstances implements org.apache.axis2.databinding.ADBBean {

    /**
     *
     */
    private static final long serialVersionUID = -8078276101173357432L;



    public static final javax.xml.namespace.QName MY_QNAME =
        new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "hasInstances", "ns1");
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                               namespacePrefix + ":hasInstances", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "hasInstances", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static HasInstances parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            final HasInstances object = new HasInstances();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"hasInstances".equals(type)) {
                            ...
                            return (HasInstances) org.wso2.bps.management.wsdl.instancemanagement.ExtensionMapper.getTypeObject(nsUri,
                                                                                                                                type,
                                                                                                                                reader);
                        }
