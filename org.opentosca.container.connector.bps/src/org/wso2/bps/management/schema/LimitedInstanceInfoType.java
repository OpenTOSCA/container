...
public class LimitedInstanceInfoType implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static LimitedInstanceInfoType parse(final javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"LimitedInstanceInfoType".equals(type)) {
                            ...
                            return (LimitedInstanceInfoType) org.wso2.bps.management.wsdl.instancemanagement.ExtensionMapper.getTypeObject(
                                nsUri, type, reader);
                        }
