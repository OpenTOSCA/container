...
public class LimitedInstanceInfoType implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = LimitedInstanceInfoType
     ...
     *
     */
    private static final long serialVersionUID = -1691875120020248768L;
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                               namespacePrefix + ":LimitedInstanceInfoType", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "LimitedInstanceInfoType",
                               xmlWriter);
            }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static LimitedInstanceInfoType parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            final LimitedInstanceInfoType object = new LimitedInstanceInfoType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"LimitedInstanceInfoType".equals(type)) {
                            ...
                            return (LimitedInstanceInfoType) org.wso2.bps.management.wsdl.instancemanagement.ExtensionMapper.getTypeObject(nsUri,
                                                                                                                                           type,
                                                                                                                                           reader);
                        }
