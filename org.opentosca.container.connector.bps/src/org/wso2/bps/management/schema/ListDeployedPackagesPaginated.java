...
public class ListDeployedPackagesPaginated implements org.apache.axis2.databinding.ADBBean {

    /**
     *
     */
    private static final long serialVersionUID = 3140864953212021377L;



    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
        "http://wso2.org/bps/management/schema", "listDeployedPackagesPaginated", "ns1");
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    namespacePrefix + ":listDeployedPackagesPaginated", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "listDeployedPackagesPaginated", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static ListDeployedPackagesPaginated parse(final javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            final ListDeployedPackagesPaginated object = new ListDeployedPackagesPaginated();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"listDeployedPackagesPaginated".equals(type)) {
                            ...
                            return (ListDeployedPackagesPaginated) org.wso2.bps.management.wsdl.instancemanagement.ExtensionMapper.getTypeObject(
                                nsUri, type, reader);
                        }
