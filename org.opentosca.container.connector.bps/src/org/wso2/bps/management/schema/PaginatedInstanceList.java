...
public class PaginatedInstanceList implements org.apache.axis2.databinding.ADBBean {

    /**
     *
     */
    private static final long serialVersionUID = 1986789658511481287L;



    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
        "http://wso2.org/bps/management/schema", "PaginatedInstanceList", "ns1");
    ...
    /**
     * field for Instance This was an Array!
     */


    protected org.wso2.bps.management.schema.LimitedInstanceInfoType[] localInstance;
     ...
     * Auto generated getter method
     *
     * @return org.wso2.bps.management.schema.LimitedInstanceInfoType[]
     */
    public org.wso2.bps.management.schema.LimitedInstanceInfoType[] getInstance() {
     ...
     */
    protected void validateInstance(final org.wso2.bps.management.schema.LimitedInstanceInfoType[] param) {
     ...
     */
    public void setInstance(final org.wso2.bps.management.schema.LimitedInstanceInfoType[] param) {

        validateInstance(param);

        this.localInstanceTracker = param != null;
     ...
     *
     * @param param org.wso2.bps.management.schema.LimitedInstanceInfoType
     */
    public void addInstance(final org.wso2.bps.management.schema.LimitedInstanceInfoType param) {
        if (this.localInstance == null) {
            this.localInstance = new org.wso2.bps.management.schema.LimitedInstanceInfoType[] {};
        }
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    namespacePrefix + ":PaginatedInstanceList", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "PaginatedInstanceList",
                    xmlWriter);
            }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static PaginatedInstanceList parse(final javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            final PaginatedInstanceList object = new PaginatedInstanceList();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"PaginatedInstanceList".equals(type)) {
                            ...
                            return (PaginatedInstanceList) org.wso2.bps.management.wsdl.instancemanagement.ExtensionMapper.getTypeObject(
                                nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement()
                    ...
                    list2.add(org.wso2.bps.management.schema.LimitedInstanceInfoType.Factory.parse(reader));
                    ...
                    object.setInstance(
                        (org.wso2.bps.management.schema.LimitedInstanceInfoType[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                            org.wso2.bps.management.schema.LimitedInstanceInfoType.class, list2));
