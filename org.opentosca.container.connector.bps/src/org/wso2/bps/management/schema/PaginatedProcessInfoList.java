...
public class PaginatedProcessInfoList implements org.apache.axis2.databinding.ADBBean {
    ...
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
        "http://wso2.org/bps/management/schema", "PaginatedProcessInfoList", "ns1");
    ...
    public void addProcessInfo(final org.wso2.bps.management.schema.LimitedProcessInfoType param) {
        ...
        list.add(param);
        this.localProcessInfo = (org.wso2.bps.management.schema.LimitedProcessInfoType[]) list.toArray(
            new org.wso2.bps.management.schema.LimitedProcessInfoType[list.size()]);
        ...
        if (this.localProcessInfoTracker) {
            if (this.localProcessInfo != null) {
                for (final LimitedProcessInfoType element : this.localProcessInfo) {
                    if (element != null) {
                        element.serialize(
                            new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "ProcessInfo"),
                            xmlWriter);
                    } else {
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static PaginatedProcessInfoList parse(final javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"PaginatedProcessInfoList".equals(type)) {
                            ...
                            return (PaginatedProcessInfoList) org.wso2.bps.management.wsdl.instancemanagement.ExtensionMapper.getTypeObject(
                                nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://wso2.org/bps/management/schema", "ProcessInfo").equals(
                        reader.getName())) {
                    ...
                    object.setProcessInfo(
                        (org.wso2.bps.management.schema.LimitedProcessInfoType[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                            org.wso2.bps.management.schema.LimitedProcessInfoType.class, list2));
