...
public class ProcessInstanceSummary implements org.apache.axis2.databinding.ADBBean {
    ...
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
        "http://wso2.org/bps/management/schema", "ProcessInstanceSummary", "ns1");
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static ProcessInstanceSummary parse(final javax.xml.stream.XMLStreamReader reader)
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        ...
                        if (reader.isStartElement()
                            ...
                            object.setProcessInstanceSummary(
                                org.wso2.bps.management.schema.InstanceSummaryType.Factory.parse(reader));
