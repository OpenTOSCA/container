...
public class Property_type0 implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = property_type0 Namespace URI =
     ...
     *
     */
    private static final long serialVersionUID = 2773793821690885536L;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                ...
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "property_type0", xmlWriter);
            }
        ...
        if (this.localName != null) {
            ...
            writeQNameAttribute("", "name", this.localName, xmlWriter);
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static Property_type0 parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            final Property_type0 object = new Property_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"property_type0".equals(type)) {
                            ...
                            return (Property_type0) org.wso2.bps.management.wsdl.instancemanagement.ExtensionMapper.getTypeObject(
                                nsUri, type, reader);
                        }
                ...
                if (tempAttribName != null) {
                    ...
                    final int index = tempAttribName.indexOf(":");
                    if (index > -1) {
