...
public class Value_type1 implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = value_type1 Namespace URI =
     ...
     *
     */
    private static final long serialVersionUID = 6904201895138778900L;
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    namespacePrefix + ":value_type1", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "value_type1", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static Value_type1 parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            final Value_type1 object = new Value_type1();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"value_type1".equals(type)) {
                            ...
                            return (Value_type1) org.wso2.bps.management.wsdl.instancemanagement.ExtensionMapper.getTypeObject(
                                nsUri, type, reader);
                        }
