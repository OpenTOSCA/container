...
public class UploadedFileItem implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            final java.lang.String namespacePrefix = registerPrefix(xmlWriter,
                "http://types.services.deployer.bpel.carbon.wso2.org/xsd");
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        if (this.localFileNameTracker) {
            elementList.add(
                new javax.xml.namespace.QName("http://types.services.deployer.bpel.carbon.wso2.org/xsd", "fileName"));

            elementList.add(
                this.localFileName == null ? null
                                           : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                               this.localFileName));
        }
        if (this.localFileTypeTracker) {
            elementList.add(
                new javax.xml.namespace.QName("http://types.services.deployer.bpel.carbon.wso2.org/xsd", "fileType"));

            elementList.add(
                this.localFileType == null ? null
                                           : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                               this.localFileType));
        }
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"UploadedFileItem".equals(type)) {
                            ...
                            return (UploadedFileItem) org.wso2.carbon.bpel.deployer.services.types.xsd.ExtensionMapper.getTypeObject(
                                nsUri, type, reader);
                        }
