...
public class UploadedFileItem implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = UploadedFileItem Namespace URI =
     * http://types.services.deployer.bpel.carbon.wso2.org/xsd Namespace Prefix = ns1
     */
     ...
     *
     */
    private static final long serialVersionUID = 4314843331535486509L;
     ...
     */
    public void setDataHandler(final javax.activation.DataHandler param) {
     ...
     */
    public void setFileType(final java.lang.String param) {
        this.localFileTypeTracker = true;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            final java.lang.String namespacePrefix =
                registerPrefix(xmlWriter, "http://types.services.deployer.bpel.carbon.wso2.org/xsd");
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                               namespacePrefix + ":UploadedFileItem", xmlWriter);
            } else {
        ...
        if (this.localDataHandlerTracker) {
            ...
            if (this.localDataHandler != null) {
                try {
                    org.apache.axiom.util.stax.XMLStreamWriterUtils.writeDataHandler(xmlWriter, this.localDataHandler,
                                                                                     null, true);
                }
        ...
        if (this.localFileTypeTracker) {
            ...
            if (this.localFileType == null) {
                ...
                xmlWriter.writeCharacters(this.localFileType);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
        ...
        if (this.localDataHandlerTracker) {
            ...
            elementList.add(this.localDataHandler);
        }
        if (this.localFileNameTracker) {
            elementList.add(new javax.xml.namespace.QName("http://types.services.deployer.bpel.carbon.wso2.org/xsd",
                "fileName"));

            elementList.add(this.localFileName == null ? null
                                                       : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localFileName));
        }
        if (this.localFileTypeTracker) {
            elementList.add(new javax.xml.namespace.QName("http://types.services.deployer.bpel.carbon.wso2.org/xsd",
                "fileType"));

            elementList.add(this.localFileType == null ? null
                                                       : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localFileType));
        }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static UploadedFileItem parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            final UploadedFileItem object = new UploadedFileItem();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"UploadedFileItem".equals(type)) {
                            ...
                            return (UploadedFileItem) org.wso2.carbon.bpel.deployer.services.types.xsd.ExtensionMapper.getTypeObject(nsUri,
                                                                                                                                     type,
                                                                                                                                     reader);
                        }
                ...
                if (reader.isStartElement()
                    && new javax.xml.namespace.QName("http://types.services.deployer.bpel.carbon.wso2.org/xsd",
                        "dataHandler").equals(reader.getName())) {
