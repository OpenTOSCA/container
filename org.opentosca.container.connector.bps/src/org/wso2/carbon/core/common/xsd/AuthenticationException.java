...
public class AuthenticationException implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = AuthenticationException
     * Namespace URI = http://common.core.carbon.wso2.org/xsd Namespace Prefix = ns30
     */
     ...
     *
     */
    private static final long serialVersionUID = 1062294419734010018L;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                ...
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "AuthenticationException",
                    xmlWriter);
            }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static AuthenticationException parse(final javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            final AuthenticationException object = new AuthenticationException();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AuthenticationException".equals(type)) {
                            ...
                            return (AuthenticationException) org.apache.axis2.transaction.xsd.ExtensionMapper.getTypeObject(
                                nsUri, type, reader);
                        }
