...
public class AuthenticationAdminAuthenticationException implements org.apache.axis2.databinding.ADBBean {
     ...
     *
     */
    private static final long serialVersionUID = -8647348264016999520L;



    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
        "http://authentication.services.core.carbon.wso2.org", "AuthenticationAdminAuthenticationException", "ns31");
    ...
    public org.wso2.carbon.core.common.xsd.AuthenticationException getAuthenticationException() {
        return this.localAuthenticationException;
    }
     ...
     */
    public void setAuthenticationException(final org.wso2.carbon.core.common.xsd.AuthenticationException param) {
        this.localAuthenticationExceptionTracker = true;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    namespacePrefix + ":AuthenticationAdminAuthenticationException", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (this.localAuthenticationExceptionTracker) {
            if (this.localAuthenticationException == null) {

                writeStartElement(null, "http://authentication.services.core.carbon.wso2.org",
                ...
                this.localAuthenticationException.serialize(new javax.xml.namespace.QName(
                    "http://authentication.services.core.carbon.wso2.org", "AuthenticationException"), xmlWriter);
            }
        }
        xmlWriter.writeEndElement();
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        if (this.localAuthenticationExceptionTracker) {
            ...
            elementList.add(this.localAuthenticationException == null ? null : this.localAuthenticationException);
        }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static AuthenticationAdminAuthenticationException parse(final javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            final AuthenticationAdminAuthenticationException object = new AuthenticationAdminAuthenticationException();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AuthenticationAdminAuthenticationException".equals(type)) {
                            // find namespace for the prefix
                            final java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (AuthenticationAdminAuthenticationException) org.apache.axis2.transaction.xsd.ExtensionMapper.getTypeObject(
                                nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement()
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        object.setAuthenticationException(
                            org.wso2.carbon.core.common.xsd.AuthenticationException.Factory.parse(reader));
