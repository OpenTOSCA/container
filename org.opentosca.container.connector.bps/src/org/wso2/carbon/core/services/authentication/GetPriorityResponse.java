...
public class GetPriorityResponse implements org.apache.axis2.databinding.ADBBean {
     ...
     *
     */
    private static final long serialVersionUID = -5846901708143685158L;



    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
        "http://authentication.services.core.carbon.wso2.org", "getPriorityResponse", "ns31");
     ...
     * @param param _return
     */
    public void set_return(final int param) {

        // setting primitive attribute tracker to true
        this.local_returnTracker = param != java.lang.Integer.MIN_VALUE;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                ...
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getPriorityResponse",
                    xmlWriter);
            }
        ...
        if (this.local_returnTracker) {
            ...
            if (this.local_return == java.lang.Integer.MIN_VALUE) {
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static GetPriorityResponse parse(final javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            final GetPriorityResponse object = new GetPriorityResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getPriorityResponse".equals(type)) {
                            ...
                            return (GetPriorityResponse) org.apache.axis2.transaction.xsd.ExtensionMapper.getTypeObject(
                                nsUri, type, reader);
                        }
