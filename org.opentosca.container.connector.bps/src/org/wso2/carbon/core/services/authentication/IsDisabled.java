...
public class IsDisabled implements org.apache.axis2.databinding.ADBBean {
     ...
     *
     */
    private static final long serialVersionUID = -3642235111941591056L;
    public static final javax.xml.namespace.QName MY_QNAME =
        new javax.xml.namespace.QName("http://authentication.services.core.carbon.wso2.org", "isDisabled", "ns31");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                ...
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "isDisabled", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static IsDisabled parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            final IsDisabled object = new IsDisabled();
