...
public class LoginWithRememberMeCookie implements org.apache.axis2.databinding.ADBBean {
     ...
     *
     */
    private static final long serialVersionUID = 5810916403049258436L;



    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
        "http://authentication.services.core.carbon.wso2.org", "loginWithRememberMeCookie", "ns31");
     ...
     * @param param Cookie
     */
    public void setCookie(final java.lang.String param) {
        this.localCookieTracker = true;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if (namespacePrefix != null && namespacePrefix.trim().length() > 0) {
                ...
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "loginWithRememberMeCookie",
                    xmlWriter);
            }


        }
        if (this.localCookieTracker) {
            namespace = "http://authentication.services.core.carbon.wso2.org";
            writeStartElement(null, namespace, "cookie", xmlWriter);


            if (this.localCookie == null) {
                ...
                xmlWriter.writeCharacters(this.localCookie);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        if (this.localCookieTracker) {
            elementList.add(
                new javax.xml.namespace.QName("http://authentication.services.core.carbon.wso2.org", "cookie"));

            elementList.add(this.localCookie == null ? null
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static LoginWithRememberMeCookie parse(final javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            final LoginWithRememberMeCookie object = new LoginWithRememberMeCookie();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"loginWithRememberMeCookie".equals(type)) {
                            ...
                            return (LoginWithRememberMeCookie) org.apache.axis2.transaction.xsd.ExtensionMapper.getTypeObject(
                                nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement()
                    ...
                    if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
                        ...
                        object.setCookie(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
