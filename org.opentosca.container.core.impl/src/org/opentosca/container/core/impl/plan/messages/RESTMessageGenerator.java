...
public class RESTMessageGenerator {
	...
	public Map<String, String> createRequest(final CSARID csarID, final QName planInputMessageID, final List<TParameterDTO> inputParameter, final String correlationID) {
