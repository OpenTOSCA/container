...
/**
 * This implementation currently acts as a Proxy to the Core Internal Credentials Service. It can in
 * future be used to modify the incoming parameters to fit another back end interface /
 * implementation.
 *
