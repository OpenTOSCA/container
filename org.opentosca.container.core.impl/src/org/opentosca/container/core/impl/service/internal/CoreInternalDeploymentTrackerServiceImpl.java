 ...
 */
public class CoreInternalDeploymentTrackerServiceImpl
    implements ICoreInternalDeploymentTrackerService, CommandProvider {

  private final static Logger LOG =
      LoggerFactory.getLogger(CoreInternalDeploymentTrackerServiceImpl.class);
   ...
   */
  @Override
  public boolean storeDeploymentState(final CSARID csarID,
      final DeploymentProcessState deploymentState) {
    this.init();
    CoreInternalDeploymentTrackerServiceImpl.LOG
        .info("Storing deployment state {} for CSAR \"{}\"...", deploymentState, csarID);
    ...
    CoreInternalDeploymentTrackerServiceImpl.LOG
        .info("Storing deployment state {} for CSAR \"{}\" completed.", deploymentState, csarID);
    return true;
  }
  ...
  public DeploymentProcessState getDeploymentState(final CSARID csarID) {
    ...
    CoreInternalDeploymentTrackerServiceImpl.LOG
        .info("Retrieving deployment state for CSAR \"{}\"...", csarID);
    this.init();
    ...
    if (info == null) {
      CoreInternalDeploymentTrackerServiceImpl.LOG
          .error("No deployment state for CSAR \"{}\" stored!", csarID);
    } else {
      deploymentState = info.getDeploymentProcessState();
      CoreInternalDeploymentTrackerServiceImpl.LOG.info("Deployment state of CSAR \"{}\": {}.",
  ...
  public void deleteDeploymentState(final CSARID csarID) {
    CoreInternalDeploymentTrackerServiceImpl.LOG.debug("Retrieving DeploymentProcessInfo for {}",
        csarID);
    final DeploymentProcessInfo info = this.getDeploymentProcessInfo(csarID);
    if (info != null) {
      CoreInternalDeploymentTrackerServiceImpl.LOG
          .debug("Beginning Transaction for removing DeploymentProcessInfo {}", csarID);
      this.em.getTransaction().begin();
      CoreInternalDeploymentTrackerServiceImpl.LOG.debug("Removing DeploymentProcessInfo {}",
          csarID);
  ...
  private DeploymentProcessInfo getDeploymentProcessInfo(final CSARID csarID) {
    ...
    this.init();
    CoreInternalDeploymentTrackerServiceImpl.LOG
        .debug("Retrieving deployment process info for CSAR \"{}\"...", csarID);
    final Query getDeploymentProcessInfo =
        this.em.createNamedQuery(DeploymentProcessInfo.getDeploymentProcessInfoByCSARID)
    ...
    if (results.isEmpty()) {
      CoreInternalDeploymentTrackerServiceImpl.LOG
          .debug("No deployment process info for CSAR \"{}\" stored.", csarID);
      return null;
    } else {
      CoreInternalDeploymentTrackerServiceImpl.LOG
          .debug("Deployment process info for CSAR \"{}\" exists.", csarID);
  ...
  public boolean storeIADeploymentInfo(IADeploymentInfo iaDeploymentInfo) {
    ...
    CoreInternalDeploymentTrackerServiceImpl.LOG.info(
        "Storing deployment state {} for IA \"{}\" of CSAR \"{}\"...",
  ...
  public IADeploymentInfo getIADeploymentInfo(final CSARID csarID, final String iaRelPath) {
    this.init();
    CoreInternalDeploymentTrackerServiceImpl.LOG
        .info("Retrieving IA deployment info for IA \"{}\" of CSAR \"{}\"...", iaRelPath, csarID);
    ...
    if (results.isEmpty()) {
      CoreInternalDeploymentTrackerServiceImpl.LOG
          .error("No IA deployment info for IA \"{}\" of CSAR \"{}\" stored.", iaRelPath, csarID);
      return null;
    } else {
      CoreInternalDeploymentTrackerServiceImpl.LOG
          .info("IA deployment info for IA \"{}\" of CSAR \"{}\" exists.", iaRelPath, csarID);
      return results.get(0);
    }
  ...
  public List<IADeploymentInfo> getIADeploymentInfos(final CSARID csarID) {
    this.init();
    CoreInternalDeploymentTrackerServiceImpl.LOG
        .info("Retrieving all IA deployment infos of CSAR \"{}\"...", csarID);
    final ArrayList<IADeploymentInfo> results = new ArrayList<>();
    final Query getIADeploymentInfo =
        this.em.createNamedQuery(IADeploymentInfo.getIADeploymentInfoByCSARID)
            .setParameter("csarID", csarID);
    @SuppressWarnings("unchecked")
    ...
    CoreInternalDeploymentTrackerServiceImpl.LOG
        .info("IA deployment infos of {} IA(s) of CSAR \"{}\" stored.", results.size(), csarID);
    return results;
  }
  ...
  public PlanDeploymentInfo getPlanDeploymentInfo(final CSARID csarID, final String planRelPath) {
    ...
    if (results.isEmpty()) {
      ...
      CoreInternalDeploymentTrackerServiceImpl.LOG
          .info("Plan deployment info for Plan \"{}\" of CSAR \"{}\" exists.", planRelPath, csarID);
      return results.get(0);
    }
  }
  ...
  public List<PlanDeploymentInfo> getPlanDeploymentInfos(final CSARID csarID) {
    this.init();
    CoreInternalDeploymentTrackerServiceImpl.LOG
        .info("Retrieving all Plan deployment infos of CSAR \"{}\"...", csarID);
    final ArrayList<PlanDeploymentInfo> results = new ArrayList<>();
    final Query getIADeploymentInfo =
        this.em.createNamedQuery(PlanDeploymentInfo.getPlanDeploymentInfoByCSARID)
            .setParameter("csarID", csarID);
    @SuppressWarnings("unchecked")
    ...
    CoreInternalDeploymentTrackerServiceImpl.LOG
        .info("Plan deployment infos of {} Plan(s) of CSAR \"{}\" stored.", results.size(), csarID);
    return results;
  }
  ...
  public boolean storeIADeploymentInfo(final CSARID csarID, final String iaRelPath,
    ...
    final IADeploymentInfo iaDeploymentInfo =
        new IADeploymentInfo(csarID, iaRelPath, iaDeploymentState);
  ...
  public boolean storePlanDeploymentInfo(final CSARID csarID, final String planRelPath,
    ...
    final PlanDeploymentInfo planDeploymentInfo =
        new PlanDeploymentInfo(csarID, planRelPath, planDeploymentState);
