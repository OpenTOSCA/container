            ...
            for (final String storageProviderID : storageProviders) {
                ...
                try {
                    ...
                    if (this.INTERNAL_CREDENTIALS_SERVICE.needsStorageProviderCredentials(storageProviderID)) {
                        ...
                        ci.println("Identity name: "
                            + this.INTERNAL_CREDENTIALS_SERVICE.getCredentialsIdentityName(storageProviderID));
                        ci.println("Key name:      "
                            + this.INTERNAL_CREDENTIALS_SERVICE.getCredentialsKeyName(storageProviderID));
