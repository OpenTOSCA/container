...
public class CredentialsJPAStore {
  ...
  public long storeCredentials(final Credentials credentials) throws UserException {
    ...
    CredentialsJPAStore.LOG.debug("Storing credentials for storage provider \"{}\"...",
        storageProviderID);
  ...
  public Credentials getCredentials(final Long credentialsID) throws UserException {
    ...
    final Query getCredentialsQuery = em.createNamedQuery(Credentials.getCredentialsByID);
  ...
  public Set<Credentials> getAllCredentialsOfStorageProvider(final String storageProviderID) {
    ...
    CredentialsJPAStore.LOG.debug("Retrieving all credentials for storage provider \"{}\"...",
        storageProviderID);

    initJPA();

    final Query getAllCredentialsByStorageProviderIDQuery =
        em.createNamedQuery(Credentials.getAllCredentialsByStorageProviderID);
  ...
  public Set<Long> getCredentialsIDs() {
    ...
    final Query getCredentialsIDsQuery = em.createNamedQuery(Credentials.getCredentialsIDs);
  ...
  public Set<Credentials> getAllCredentials() {
    ...
    final Query getAllCredentialsQuery = em.createNamedQuery(Credentials.getAllCredentials);
  ...
  public void deleteCredentials(final long credentialsID) throws UserException {
    ...
    em.getTransaction().begin();
    final Query removeCredentialsQuery = em.createNamedQuery(Credentials.removeCredentialsByID);
  ...
  public void deleteAllCredentials() {
    ...
    em.getTransaction().begin();
    final Query removeAllCredentialsQuery = em.createNamedQuery(Credentials.removeAllCredentials);
