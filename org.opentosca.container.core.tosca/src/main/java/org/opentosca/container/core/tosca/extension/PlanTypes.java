...
public enum PlanTypes implements Comparable<PlanTypes>, Serializable {
  ...
  BUILD("http://docs.oasis-open.org/tosca/ns/2011/12/PlanTypes/BuildPlan"), OTHERMANAGEMENT("undefined or custom management plan"), APPLICATION("http://www.opentosca.org"), TERMINATION("http://docs.oasis-open.org/tosca/ns/2011/12/PlanTypes/TerminationPlan");

  private String type;

  PlanTypes(final String type) {
    this.type = type;
  }
   ...
   * The enum BUILD has the URI http://docs.oasis-open.org/tosca/ns/2011/12/PlanTypes/BuildPlan. This
   * method returns for BUILD the String "BUILD".
   *
   * @return String representation
   */
  public String toEnumRepresentation() {
    if (this.type.startsWith(PlanTypes.BUILD.toString())) {
      return "BUILD";
    } else if (this.type.startsWith(PlanTypes.TERMINATION.toString())) {
      return "TERMINATION";
    } else if (this.type.startsWith(PlanTypes.APPLICATION.toString())) {
      return "APPLICATION";
    } else {
   ...
   */
  public static PlanTypes isPlanTypeURI(final String planType) {
  ...
  /**
   * Checks the given String if it is one of the ENUM Strings defined in this ENUM (BUILD and
   * TERMINATION). If not, the Type is of OTHERMANAGEMENT.
   * <p/>
   * For example: The given parameter contains the String "BUILD". This String is mapped to the enum
   * BUILD.
   *
   * @param planType String
   * @return PlanTypes plan type.
   */
  public static PlanTypes isPlanTypeEnumRepresentation(final String planType) {
