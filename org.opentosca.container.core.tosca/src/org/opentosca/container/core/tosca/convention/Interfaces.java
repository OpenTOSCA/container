...
public class Interfaces {
    ...
    public static final String OPENTOSCA_DECLARATIVE_INTERFACE_SERVERLESS_REMOVEFUNCTION = "removeFunction";
    public static final String OPENTOSCA_DECLARATIVE_INTERFACE_SERVERLESS_REMOVEEVENT = "removeEvent";
