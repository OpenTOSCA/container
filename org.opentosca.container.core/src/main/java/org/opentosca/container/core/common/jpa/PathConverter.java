...
/**
 * This class is used to convert {@link Path} to String, and {@link String} back to {@link Path} when persisting {@link
 * Path} fields with JPA. The conversion needs to be done, as we cannot directly query for {@link Path} in JPQL.
 */
