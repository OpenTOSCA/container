...
/**
 * This class is used to convert QNames to String, and Strings back to QNames when persisting QName fields with JPA. The
 * conversion needs to be done, as we cannot directly query for QNames in JPQL.
 */
@Converter
