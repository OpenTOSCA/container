...
/**
 * This class is used to convert URIs to String, and Strings back to URIs when persisting URI fields with JPA. The
 * conversion needs to be done, as we cannot directly query for URI in JPQL.
 */
@Converter
