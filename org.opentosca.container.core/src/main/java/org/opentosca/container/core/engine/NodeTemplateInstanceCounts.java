...
/**
 * This class holds data for a NodeTemplate and it's min and maxOccurence This information is stored in a Hashmap. There
 * the QName of the NodeTemplate is mapped to the Occurences of this NodeTemplate specified in the NodeTemplate
 */
public class NodeTemplateInstanceCounts {

    /**
     * @author Marcus Eisele - marcus.eisele@gmail.com This class encapsulates the minInstances and maxInstances value
     */
