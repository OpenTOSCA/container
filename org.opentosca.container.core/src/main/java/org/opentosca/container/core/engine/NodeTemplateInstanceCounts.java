...
/**
 * This class holds data for a NodeTemplate and it's min and maxOccurence This information is stored
 * in a Hashmap. There the QName of the NodeTemplate is mapped to the Occurences of this
 * NodeTemplate specified in the NodeTemplate
 */
public class NodeTemplateInstanceCounts {

    /**
     * @author Marcus Eisele - marcus.eisele@gmail.com This class encapsulates the minInstances and
     *         maxInstances value
     *
     */
    ...
    /**
     * Add an additional entry for the given QName to the Hashmap (all previous entries for QNAME will
     * be <b>overwritten</b>
     *
     * @param qnameOfNodeTemplate
     * @param minInstances - number of minimalInstances of this specific NodeTemplate
     * @param maxInstances - number of maximalInstances of this specific NodeTemplate. <b>unbounded is
     *        modelled as -1</b>
     */
