...
public final class ToscaEngine {
  ...
  /**
   * Resolves a ServiceTemplate from a csar by it's <b>local</b> id.
   * If no matching serviceTemplate can be found, an Exception is thrown.
   *
   ...
   * @return A {@link TServiceTemplate} instance from within the given CSAR where the local id matches
