...
/**
 * Interface of the XML Serialization for marshaling and unmarshaling objects of the TOSCA universe
 * to the needed JAXB or DOM objects as well as other XML content to DOM objects. Instances of this
 * Interface can be created with the SerializerFactory.
 * <p>
 * An implementation of this interface provides functionality for processing XML data in files and
 * JAXB objects. Further the Serializer can convert these data to DOM and String representations.
 * <p>
 * The instance of this interface is used by <br>
 * - org.opentosca.containerapi<br>
 * - org.opentosca.core.model<br>
...
public interface IXMLSerializer {
   ...
   * @return ServiceTemplate The ServiceTemplate which contains the xml data of the File. The method
   * returns null if the file is empty or one or more errors occurs.
   */
   ...
   * @return The ServiceTemplate which contains the xml data. The method returns null if the stream is
   ...
   * @return ServiceTemplate The ServiceTemplate which contains the xml data. The method returns a
   * null if the file is empty or one or more errors occurs.
   */
  public abstract Definitions unmarshal(Document doc);

  /**
   * This method unmarshals a object of a passed DOM Node. For the mapping you need to provide the
   * destination class with which a instance is generated and the data is stored.
   *
   ...
   * @return The JAXBElement of the given object or null if the given object is not in the context of
   * the TOSCA JAXB classes.
   */
  @SuppressWarnings("rawtypes")
  public abstract JAXBElement createJAXBElement(Object obj);

  /**
   * This method puts a given DOM Element into a proper DOM Document structure. The root element in
   * the new document is a copy of the original one.
   *
  ...
  /**
   * This method puts a given list of DOM Elements into a proper DOM Document structure. The original
   * elements are copied and the new elements are put into a new root element with the name depending
  ...
  /**
   * This method sets the validation against the schema active or inactive. By default the validation
   * is activated.
   *
