...
public class XMLSerializerFactory implements IXMLSerializerFactory {
    ...
    /**
     * Creates a new instance of the XML Serializer of the TOSCA universe for a passed class which marks the context and
     * a File object which represents the TOSCA Schema.
     *
