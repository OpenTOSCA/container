...
public abstract class AbstractDAO {
    ...
    /**
     * This method initializes the EntityManager/Factory in case it is not connected/setup yet. It is called by each
     * method, to ensure that a connection exists. (Robustness!)
     */
    protected void init() {
        if (this.em == null) {
