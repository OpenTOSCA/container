...
/**
 * Matches files at an artifact reference against include and exclude patterns. An include pattern includes certain
 * files at a reference in the artifact. By analogy, an exclude pattern excludes files from the artifact. A pattern must
 * be given as a regular expression (RegExp).
 */
public class PatternMatcher {
    ...
    /**
     * Matches {@code file} against {@code includePatterns} and {@code excludePatterns} using {@link
     * #findFilesMatchesPatterns(Set, Set, Set)}.
     *
     ...
     * @return {@code true} if {@code file} matches against the include and exclude patterns, otherwise {@code false}.
     * If no patterns were given, {@code true} will be returned.
    ...
    /**
     * Matches {@code files} against {@code includePatterns} and {@code excludePatterns} in the following way:<br /> <br
     * /> 1. Matches {@code files} against the include patterns. A matched file will be added to a Set X. If no include
     * patterns were given, all files will be added to X.<br /> 2. Files in X will be matched against the exclude
     * patterns. If a file matches, it will be removed from X.<br /> <br /> Finally Set X contains the files that
     * matches the include and exclude patterns.
     *
     ...
     * @return Files that matches the include and exclude patterns. If no patterns were given, all given files will be
     * returned.
     */
