...
/**
 * Credentials for a storage provider. A credentials consists of an identity and a key. Used by the
 * Credentials Service, a storage provider and in the Container API for a Credentials JAXB model
 * (thus it has JAXB annotations).
 */
...
public class Credentials {
     ...
     * Will be automatically generated if an object of this class is persisted using Eclipse Link.
     */
