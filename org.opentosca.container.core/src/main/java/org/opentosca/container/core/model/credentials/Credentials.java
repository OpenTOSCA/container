...
/**
 * Credentials for a storage provider. A credentials consists of an identity and a key. Used by the Credentials Service,
 * a storage provider and in the Container API for a Credentials JAXB model (thus it has JAXB annotations).
 */
...
public class Credentials {
    ...
    /**
     * Identifies these credentials.<br /> Will be automatically generated if an object of this class is persisted using
     * Eclipse Link.
     */
    ...
    /**
     * Identity of these credentials.<br /> E.g. on Amazon S3 it's the Access Key ID.
     */
    ...
    /**
     * Key of these credentials.<br /> E.g. on Amazon S3 it's the Secret Access Key.
     */
    @XmlElement(name = "Key")
    @Column(name = "\"key\"")
    private String key;
     ...
     *
     * @param storageProviderID of the storage provider for that the credentials are indented for.
     * @param identity          of the credentials.
     * @param key               of the credentials.
     * @param description       of the credentials (optional)
     */
    public Credentials(final String storageProviderID, final String identity, final String key,
    ...
    /**
     * @return ID of the storage provider for that these credentials are intended for.
     */
    ...
    /**
     * Sets the ID of the storage provider for that these credentials are intended for.
     *
    ...
    /**
     * @return Description of these credentials.<br /> It's optional. If no description exists {@code null}.
     */
