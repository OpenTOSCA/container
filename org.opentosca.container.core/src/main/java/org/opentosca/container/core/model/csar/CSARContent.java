...
public class CSARContent implements IBrowseable {
  ...
  private Set<AbstractFile> getImportFiles(final String fileExtension) {
    ...
    final AbstractDirectory importsDirectory = getDirectory(this.IMPORTS_DIR_REL_PATH);
   ...
   *                         supported.
   */
  public AbstractArtifact resolveArtifactReference(final String artifactReference) throws UserException,
    SystemException {
  ...
  public Set<AbstractFile> getTOSCAsInDefinitionsDir() {
    ...
    final AbstractDirectory definitionsDir = getDirectory(this.CSAR_DEFINITIONS_DIR_REL_PATH);
  ...
  public AbstractFile getRootTOSCA() {
    ...
    if (relPathOfRootTOSCA != null) {
      ...
      if (rootTOSCA != null) {
        ...
        CSARContent.LOG.warn("Root TOSCA path \"{}\" specified in TOSCA meta file of CSAR \"{}\" points to a non-existing file.",
  ...
  public AbstractFile getTopologyPicture() {
    ...
    if (topologyPictureRelPath != null) {
      ...
      if (topologyPicture != null) {
        ...
        CSARContent.LOG.warn("Topology picture path specified in TOSCA meta file of CSAR \"{}\" points to a non-existing file.",
          this.csarID);
      }
    } else {
