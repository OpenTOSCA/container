...
public abstract class AbstractEndpoint {
    ...
    /**
     * The host name of the OpenTOSCA Container where the CSAR identified by {@link GenericEndpoint#csarId} is deployed.
     * This attribute is needed to clearly identify CSARs and service instances for collaboration, because otherwise
    ...
    /**
     * Identifies a service instance of the CSAR defined by {@link GenericEndpoint#csarId} where this endpoint belongs
     * to. Some endpoints belong to a certain service instance of a CSAR (IA endpoints) whereas others only belong to a
     * CSAR (Plan endpoints). Therefore, this field is set for IA endpoints and it is <tt>null</tt> for Plan endpoints.
     */
    @Basic
