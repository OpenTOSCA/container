...
public class RelationInstance {
    ...
    private NodeInstance sourceInstance;
     ...
     *
     * @param relationshipTemplateID   - the relationshipTemplateID specified by the Namespace and the ID value of the
    ...
    /**
     * The ID persisted in the database is "only" an integer. To the outside, we need the ID to be an URI. To avoid
     * storing two IDs in the database we generate the URI ID out of the integer ID. Therefore, when reading a
     * NodeInstance object from the database we need to set the URI ID accordingly.
     */
    @PostLoad
    @PostPersist
    public void setRelationInstanceID() {
        try {
            this.relationInstanceID = new URI(Settings.CONTAINER_API_LEGACY + "/CSARs/"
                + this.serviceInstance.getCSAR_ID() + "/ServiceTemplates/"
    ...
    public String toString() {
        return "RelationInstance [id=" + this.id + ", relationInstanceID=" + this.relationInstanceID
            ...
            + this.relationshipTemplateName + ", created=" + this.created + ", serviceInstance=" + this.serviceInstance
            + ", properties=" + this.properties + "]";
    }

    public void setRelationInstanceID(final URI relationInstanceID) {
    ...
    public void setRelationshipTemplateName(final String relationshipTemplateName) {
        this.relationshipTemplateName = relationshipTemplateName;
    }
    ...
    public void setSourceInstance(final NodeInstance sourceInstance) {
        this.sourceInstance = sourceInstance;
    }

    public void setTargetInstance(final NodeInstance targetInstance) {
