...
/**
 * This interface defines the standard HTTP commands as methods, plus some specific methods mainly
 * created for the AAR plug-in of the IAEngine, that are provided by the HTTPService.
 *
