 ...
 * ServiceTemplates (=ServiceInstances) and NodeTemplates (NodeInstances) and properties of
 * NodeInstances.
 */
public interface IInstanceDataService {
   ...
   * nodeInstance has to match all parameters to be returned
   *
   ...
   * relationInstance has to match all parameters to be returned
   *
