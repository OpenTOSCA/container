...
/**
 * Interface of the PlanInvocationEngine. This service provides a the functionality of invoking PublicPlans, getting a
 * list of CorrelationIDs of active PublicPlans and one specific PublicPlan.
 */
public interface IPlanInvocationEngine {
    ...
    /**
     * Invoke a PublicPlan for a CSAR. If this PublicPlan is of Type OTHERMANAGEMENT or TERMINATION, the information
     * about the CSARInstance is stored inside the PublicPlan.
     */
