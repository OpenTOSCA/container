...
public class ToscaReferenceMapper implements IToscaReferenceMapper {
	...
	private final Map<CSARID, Map<QName, List<String>>> mapCSARIDToServiceTemplateQNameToRelationshipTemplateID = new HashMap<>();
	...
	public void storeRelationshipTemplateIDForServiceTemplateANdCSAR(final CSARID csarId, final QName serviceTemplateID, final String id) {
		if (!this.mapCSARIDToServiceTemplateQNameToRelationshipTemplateID.containsKey(csarId)) {
			this.mapCSARIDToServiceTemplateQNameToRelationshipTemplateID.put(csarId, new HashMap<QName, List<String>>());
		}
