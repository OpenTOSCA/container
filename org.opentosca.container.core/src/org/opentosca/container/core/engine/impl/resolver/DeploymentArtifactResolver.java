 ...
 * to the TOSCA specification wd14. Each found element and the document in which the element is
 * nested is stored by the org.opentosca.core.model.toscareferencemapping.ToscaReferenceMapper.
 *
 * Preconditions for resolving a DeploymentArtifact: Definitions has to be valid in all kind of
 * meanings.
 *
...
public class DeploymentArtifactResolver extends GenericResolver {
    ...
    /**
     * Instantiate an object of the Resolver to resolve references inside of DeploymentArtifacts. This
    ...
    /**
     * Resolves a DeploymentArtifact and stores the mapping into the ToscaReferenceMapper.
     *
