...
public class ReferenceMapper {
    ...
    private ReferenceResultWrapper searchElementWithID(final QName elementReference, final String documentType) {
        ...
        if (!this.mapOfNSToDocuments.containsKey(elementReference.getNamespaceURI())) {
            this.LOG.warn("The namespace \"" + elementReference.getNamespaceURI()
    ...
    private ReferenceResultWrapper searchElementWithName(final QName elementReference, String elementName,
        ...
        this.LOG.debug("Search for a name for the QName \"" + elementReference.toString() + "\" inside of an element \""
            + elementName + "\".");
    ...
    protected boolean searchElementViaIDREF(final Object targetElement, final String targetNamespace) {
        ...
        if (!(targetElement instanceof TNodeTemplate || targetElement instanceof TRequirement
            || targetElement instanceof TCapability)) {
            this.LOG.error("The referenced element is of the Type \"" + targetElement.getClass().getCanonicalName()
    ...
    protected boolean searchToscaElementByQNameWithID(final QName reference) {
        ...
        if (wrapper.getNodeList().getLength() == 1) {
            ...
            // found too much
            this.LOG.error("There are " + wrapper.getNodeList().getLength()
    ...
    protected boolean searchToscaElementByQNameWithName(final QName reference, final ElementNamesEnum element) {
        ...
        // search
        this.LOG.debug("Search for a " + element + " inside of a Definitions with the name \""
