...
public class CSARFile extends AbstractFile {
    ...
    public Path getFile() throws SystemException {
        ...
        if (this.isStorageProviderReady(this.STORAGE_PROVIDER_ID)) {
            ...
            throw new SystemException("Can't retrieve file \"" + this.getPath() + "\" of CSAR \"" + this.CSAR_ID
                + "\", because storage provider \"" + this.STORAGE_PROVIDER_ID + "\" is not available and ready.");
        }
    ...
    public InputStream getFileAsInputStream() throws SystemException {
        ...
        if (this.isStorageProviderReady(this.STORAGE_PROVIDER_ID)) {
            ...
            throw new SystemException("Can't retrieve file \"" + this.getPath() + "\" of CSAR \"" + this.CSAR_ID
                + "\" as input stream, because storage provider \"" + this.STORAGE_PROVIDER_ID + "\" is not ready.");
        }
    ...
    public String toString() {
        return "File \"" + this.getPath() + "\" of CSAR \"" + this.CSAR_ID + "\" on storage provider \""
            + this.STORAGE_PROVIDER_ID + "\".";
    }
    ...
    public boolean equals(final Object file) {
        if (file instanceof CSARFile) {
            ...
            if (this.getPath().equals(csarFile.getPath()) && this.CSAR_ID.equals(csarFile.CSAR_ID)
                && this.STORAGE_PROVIDER_ID.equals(csarFile.STORAGE_PROVIDER_ID)) {
                return true;
            }
        }
        return false;
