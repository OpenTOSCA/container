...
public interface IBrowseable {
    ...
    /**
     * @param relPathOfDirectory - directory path relative to this directory / root.
     * @return {@link AbstractDirectory} of directory {@code relPathOfDirectory} . If it not exists
     *         {@code null}.
     */
     ...
     * @return {@link AbstractFile} of file {@code relPathOfFile}. If it not exists {@code null}.
     */
    public AbstractFile getFile(String relPathOfFile);

    /**
     * @return {@code Set} containing {@link AbstractDirectory} of directories in this directory (not
     *         recursively).
     */
    public Set<AbstractDirectory> getDirectories();

    /**
     * @return {@code Set} containing {@link AbstractFile} of files in this directory (not recursively).
     */
    public Set<AbstractFile> getFiles();

    /**
     * @return {@code Set} containing {@link AbstractFile} of files in this directory and it's sub
