...
public class CSARIDToInstanceToCorrelation {
	...
	public ServiceTemplateInstanceID storeNewCSARInstance(final CSARID csarID, final QName serviceTemplateId) {
		...
		final ServiceTemplateInstanceID instance = new ServiceTemplateInstanceID(csarID, serviceTemplateId, highest + 1);
	 ...
	 */
	public void storeNewCorrelationForInstance(final CSARID csarID, final ServiceTemplateInstanceID instanceID, final String correlationID) {
