...
public class PlanCorrelationToPlanInvocationEvent {
  ...
  private final Map<String, PlanInvocationEvent> storageMap =
  ...
  public void storePlan(final String planCorrelation,
      final PlanInvocationEvent planInvocationEvent) {
