...
/**
 * This class maps a CorrelationID to a PlanInvocationEvent for the CSARInstance
 * History.
 */
public class PlanCorrelationToPlanInvocationEvent {
	...
	private final Map<String, PlanInvocationEvent> storageMap = new HashMap<String, PlanInvocationEvent>();
