...
/**
 * Analyzes a given list of Implementation Artifacts if they are deployable, meaning checking if the
 * Required Capabilities of the Implemenation Artifacts are met by the container and/or available
 * plug-ins.
 *
 * There are two main private methods that check if any capabilites are met by the container and
 * respectively by any bound plug-in. The supplied list of all Implementation Artifacts is modified
 * accordingly. Meaning that any Implementation Artifact that is not deployable, is removed from
 * this list and is added to the list of failed Implementation Artifacts.
 */
...
public class IAEngineCapabilityChecker {
    ...
    /**
     *
     * Removes Container and PlanCapabilities from the requiredCapabilities List.
     *
