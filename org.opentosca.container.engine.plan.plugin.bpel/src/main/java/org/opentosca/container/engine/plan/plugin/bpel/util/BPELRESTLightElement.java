...
/**
 * This class provides a mapping between Java and BPEL4RESTLight XML elements. It provides funtionality conform to the
 * rules in BPELRESTLightUpdater when updating URIs on the DOM Nodes.
 */
public class BPELRESTLightElement {
     ...
     * @throws NoBPELRESTLightElementException when the given node isn't a extension activity from BPEL4RESTLight ODE
     *                                         Extension conforming the above rules
     */
     ...
     *
     * @return a URI. The uri can be just a part of the real URI value in the DOM if it contains $bpelvar[bpelVariable]
     */
    public URI getURI() {
        switch (this.uriType) {
            case BPELVAR:
     ...
     * @throws NoBPELRESTLightElementException whenever the uri value doesn't apply to rules specified for
     *                                         BPEL4RESTLight elements
     */
