 ...
 * {@link org.opentosca.container.engine.plan.plugin.bpelwso2.util.BPELRESTLightUpdater}
 ...
 * {@link org.opentosca.container.engine.plan.plugin.bpelwso2.util.ODEEndpointUpdater}
 * to update the bindings inside the used WSDL Descriptions referenced in the
 * BPEL process. The endpoints for the update are retrieved trough a service
 * that implements the
 ...
 * {@link org.opentosca.container.engine.plan.plugin.bpelwso2.util.Messages}
 * class. The plugin uses {@link org.opentosca.bpsconnector.BpsConnector} class
 * to deploy the updated plan unto the WSO2 BPS behind the endpoint.
 *
