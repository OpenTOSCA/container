...
public class ODEEndpointUpdater {
     ...
     */
    public ODEEndpointUpdater(final String servicesRoot) throws WSDLException {
    ...
    private List<WSDLEndpoint> getWSDLEndpointForBPSCallback(final Service service, final Port port) {
        ...
        /*
         * The BPS creates addresses by using the Service Name OpenTOSCA_On_VSphere.csarInvokerService
