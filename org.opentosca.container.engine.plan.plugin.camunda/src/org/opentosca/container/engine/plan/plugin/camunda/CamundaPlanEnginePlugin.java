...
public class CamundaPlanEnginePlugin implements IPlanEnginePlanRefPluginService {
	...
	private void bindServices() {
		...
		final ServiceReference<IToscaEngineService> toscaEngine = context.getServiceReference(IToscaEngineService.class);
		this.toscaEngineService = context.getService(toscaEngine);
		
		final ServiceReference<ICoreEndpointService> endpointService = context.getServiceReference(ICoreEndpointService.class);
