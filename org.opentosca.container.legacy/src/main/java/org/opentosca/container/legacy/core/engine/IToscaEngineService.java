...
public interface IToscaEngineService {
   ...
   * @param typeID        of the NodeType or RelationshipType containing the operation.
   * @param interfaceName of the operation.
   * @param operationName name of which the parameters should be returned.
   ...
   * @param nodeTypeImplementationID the QName reference to a NodeTemplate or NodeTypeImplementation.
