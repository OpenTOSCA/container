...
public class CSARValidator {
    ...
    /**
     * Creates a {@link CSARValidator}.<br /> After creation {@link #isValid()} should be called to validate the CSAR
     * content.
     *
    ...
    /**
     * @return Occurred errors during validation of CSAR. If CSAR was not validated yet using {@link
     * CSARValidator#isValid()} or no errors occurred {@code null}.
     */
     ...
     * @return {@code true} if {@code Definitions} directory of CSAR {@code csarID} contains at least one TOSCA file,
