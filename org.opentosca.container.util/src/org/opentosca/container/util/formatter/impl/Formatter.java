...
/**
 * Using this class ensures a proper formatting of any given data type into a
 * specified form by providing a resulting object of the formatted data. The
 * formatted data is contained within the corresponding FormattingResult data
 * type. The output data type of a Formatter is always the same as the input
 * data type.
 * 
 * @author Stefan
 *
...
public abstract class Formatter<T> implements AbstractFormatter<T> {
	...
	/**
	 * Contains the result of the formatting process. This class has to be public
	 * but its constructor may only be called by the Formatter itself.
	 * 
	 * @author Stefan
	 *
	 */
