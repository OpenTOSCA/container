...
public class PoliciesListResource {
    ...
    public org.opentosca.model.tosca.TBoundaryDefinitions.Policies getPolicies(@QueryParam("csarID") String csarID,@QueryParam("namespace") String namespaceServiceTemplate,
	...
	Policies policies = ToscaServiceHandler.getToscaEngineService()
	    .getToscaReferenceMapper().getPolicies(csarID_csarID, templateID);
