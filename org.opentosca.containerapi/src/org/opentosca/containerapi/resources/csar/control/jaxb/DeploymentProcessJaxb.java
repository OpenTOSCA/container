...
public class DeploymentProcessJaxb {
	 ...
	 */
	public void setDeploymentState(DeploymentProcessState deploymentState) {
	 ...
	 * @param csarID to set
	 */
	public void setProcessID(CSARID csarID) {
	...
	public Set<OperationJaxb> getOperations() {
		if (this.operations == null) {
			return new HashSet<OperationJaxb>();
		} else {
	 ...
	 */
	public void setOperations(Set<OperationJaxb> operations) {
