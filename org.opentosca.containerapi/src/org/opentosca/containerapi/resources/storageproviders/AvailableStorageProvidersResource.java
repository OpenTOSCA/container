...
import org.opentosca.containerapi.resources.storageproviders.jaxb.StorageProvidersJaxb;
...
public class AvailableStorageProvidersResource {
	...
	/**
	 * Gets the storage providers that will be showed on this resource. It
	 * depends on the query parameter {@code type} passed by the user.
	 * 
	 * @param type - optional query parameter that determines if only storage
	 *            providers with a certain property (
	 *            {@link StorageProviderProperties}) should be showed. If type
	 *            is invalid all storage providers will be showed.
	...
	public StorageProvidersJaxb getStorageProviders(@QueryParam("type") String type) {
	 ...
	 * {@code storageProviderID}. If storage provider {@code storageProviderID}
	 * is not available it will be created with {@code null}.
	 * 
	 * @param storageProviderID of storage provider
	 * @return {@link AvailableStorageProviderResource}
	 */
	@Path("{id}")
	public AvailableStorageProviderResource getStorageProviderResource(@PathParam("id") String storageProviderID) {
