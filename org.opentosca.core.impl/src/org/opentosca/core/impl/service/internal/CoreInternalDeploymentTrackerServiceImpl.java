 ...
 * Plans by providing methods for storing and getting it deployment states. It
 * is used by OpenTOSCA Control to allowing only a subset of all provided
...
public class CoreInternalDeploymentTrackerServiceImpl implements ICoreInternalDeploymentTrackerService, CommandProvider {
	...
	public IADeploymentInfo getIADeploymentInfo(final CSARID csarID, final String iaRelPath) {
		...
		final Query getIADeploymentInfo = this.em.createNamedQuery(IADeploymentInfo.getIADeploymentInfoByCSARIDAndRelPath).setParameter("iaRelPath", iaRelPath).setParameter("csarID", csarID);
		@SuppressWarnings("unchecked")
	...
	public List<IADeploymentInfo> getIADeploymentInfos(final CSARID csarID) {
		...
		final Query getIADeploymentInfo = this.em.createNamedQuery(IADeploymentInfo.getIADeploymentInfoByCSARID).setParameter("csarID", csarID);
		@SuppressWarnings("unchecked")
	...
	public PlanDeploymentInfo getPlanDeploymentInfo(final CSARID csarID, final String planRelPath) {
		...
		final Query getPlanDeploymentInfo = this.em.createNamedQuery(PlanDeploymentInfo.getPlanDeploymentInfoByCSARIDAndRelPath).setParameter("csarID", csarID).setParameter("planRelPath", planRelPath);
		@SuppressWarnings("unchecked")
	...
	public List<PlanDeploymentInfo> getPlanDeploymentInfos(final CSARID csarID) {
		...
		final Query getIADeploymentInfo = this.em.createNamedQuery(PlanDeploymentInfo.getPlanDeploymentInfoByCSARID).setParameter("csarID", csarID);
		@SuppressWarnings("unchecked")
