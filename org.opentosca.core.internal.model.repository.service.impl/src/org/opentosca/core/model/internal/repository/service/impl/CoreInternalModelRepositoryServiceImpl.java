package org.opentosca.core.model.internal.repository.service.impl;
...
public class CoreInternalModelRepositoryServiceImpl implements ICoreInternalModelRepositoryService, CommandProvider {
	...
	// " (DefinitionsID VARCHAR(1000) NOT NULL, DefinitionsXML BLOB NOT NULL, PRIMARY KEY (DefinitionsID))";
	...
	// try {
	// CoreInternalModelRepositoryServiceImpl.LOG.info("Checking if Tables already exist...");
	...
	// CoreInternalModelRepositoryServiceImpl.LOG.info("Table did not exist. Creating...");
	...
	// if (definitions == null) {
	// CoreInternalModelRepositoryServiceImpl.LOG.error("Unmarshalling TOSCA file {} failed!",
	// toscaFile.getName());
	// return null;
	// }
	//
	...
	//
	// CoreInternalModelRepositoryServiceImpl.LOG.info("Storing TOSCA file {} with Definitions ID \"{}\"...",
	...
	// this.pstmt.execute();
	// CoreInternalModelRepositoryServiceImpl.LOG.info("Storing TOSCA file {} with Definitions ID \"{}\" completed.",
	// toscaFile.getName(), definitionsIDQName.toString());
	// return definitionsIDQName;
	//
	// } catch (SQLException e) {
	// if
	// (e.getLocalizedMessage().contains("duplicate key value in a unique or primary key constraint or unique index"))
	// {
	// CoreInternalModelRepositoryServiceImpl.LOG.warn("Error while writing TOSCA / Definitions to database. It already exists!",
	// e);
	// } else {
	// CoreInternalModelRepositoryServiceImpl.LOG.error("Error while writing TOSCA / Definitions to database.",
	// e);
	// }
	...
	// CoreInternalModelRepositoryServiceImpl.LOG.info("Reading file {} to String",
	...
	public List<QName> getAllDefinitionsIDs(CSARID csarID) {
		...
		// }
		// } catch (SQLException e) {
		// CoreInternalModelRepositoryServiceImpl.LOG.error("Getting IDs of all stored Definitions failed!",
		// e);
		// } finally {
		// if (this.pstmt != null) {
		// try {
	...
	public TDefinitions getDefinitions(CSARID csarID, QName definitionsID) {
		...
		if (this.toscaEngineService != null) {
			Object definitions = this.toscaEngineService.getToscaReferenceMapper().getJAXBReference(csarID, definitionsID);
		...
		// } else {
		// CoreInternalModelRepositoryServiceImpl.LOG.error("Definitions with ID \"{}\" is not stored!",
		...
		// } catch (SQLException e) {
		// CoreInternalModelRepositoryServiceImpl.LOG.error("Getting Definitions with ID \"{}\" failed!",
	...
	// definitionsID) {
	//
	// CoreInternalModelRepositoryServiceImpl.LOG.info("Getting service template IDs of Definitions with ID \"{}\"...",
	// definitionsID.toString());
	//
	...
	// }
	//
	// CoreInternalModelRepositoryServiceImpl.LOG.info("Definitions with ID \"{}\" consists of {} service templates.",
	...
	//
	// int num = 0;
	// CoreInternalModelRepositoryServiceImpl.LOG.info("Deleting all Definitions stored in Core Model Repository...");
	// try {
	...
	// } catch (SQLException e) {
	// CoreInternalModelRepositoryServiceImpl.LOG.error("Deleting Definitions in Core Model Repository failed!",
	// e);
	// } finally {
	//
	// if (this.pstmt != null) {
	...
	//
	// CoreInternalModelRepositoryServiceImpl.LOG.info("Deleting Definitions with ID \"{}\"...",
	// definitionsID.toString());
	// try {
	// this.pstmt = this.conn.prepareStatement(this.deleteDefinitionsByID);
	// this.pstmt.setString(1, definitionsID.toString());
	// if (this.pstmt.executeUpdate() > 0) {
	// CoreInternalModelRepositoryServiceImpl.LOG.info("Deleting Definitions with ID \"{}\" completed.",
	// definitionsID.toString());
	// return true;
	// } else {
	// CoreInternalModelRepositoryServiceImpl.LOG.error("Definitions with ID \"{}\" doesn't exist.",
	// definitionsID.toString());
	// }
	// } catch (SQLException e) {
	// CoreInternalModelRepositoryServiceImpl.LOG.info("Deleting Definitions with ID \"{}\" failed.",
	// definitionsID.toString(), e);
	// } finally {
	// if (this.pstmt != null) {
	// try {
	...
	// CoreInternalModelRepositoryServiceImpl.LOG.info("Binding XML Serializer Service bound.");
	// }
	//
	...
	//
	// this.xmlSerializerService = xmlSerializerService;
	// CoreInternalModelRepositoryServiceImpl.LOG.info("XML Serializer Service unbound.");
	// }
