package org.opentosca.core.model.credentials;
...
/**
 * Credentials for a storage provider.<br />
 * A credentials consists of an identity and a key.<br />
 * Used by the Credentials Service, a storage provider and in the Container API
 * for a Credentials JAXB model (thus it has JAXB annotations).<br />
 * <br />
 ...
 * 
 * @todo Maybe some storage providers added in the future have more complex
 *       credentials. Then we have to extend this model respectively create a
...
public class Credentials {
	 ...
	 */
	public Credentials(String storageProviderID, String identity, String key, String description) {
