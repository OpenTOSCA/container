package org.opentosca.core.tosca.extension;
...
import org.opentosca.core.tosca.model.TParameter;
...
public class TPlanDTO {
	...
	public String toString() {
		...
		builder.append("Plan with ID \"" + this.id + "\", name \"" + this.name + "\", of type \"" + this.planType + "\", language \"" + this.planLanguage + "\" and input [");
