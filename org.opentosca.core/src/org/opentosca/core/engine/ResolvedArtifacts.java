package org.opentosca.core.engine;
...
/**
 * This class holds data for an resolved Artifact (Implementation or
 * DeploymentArtifact) therefore it contains name, type and
...
public class ResolvedArtifacts {
	 ...
	 * This is a generic class so therefore there wont be an object of this
	 * (abstract!) Use a child class instead (see ResolvedDeploymentArtifact and
	 * ResolvedImplementationArtifact)
	 */
	...
	/**
	 * extends ResolvedArtifact by the ImplementationArtifact-specific fields
	 * operationName and interfaceName
	 */
