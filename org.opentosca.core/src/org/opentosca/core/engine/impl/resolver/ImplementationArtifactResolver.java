...
import org.opentosca.core.tosca.StaticTOSCANamespaces;
...
public class ImplementationArtifactResolver extends GenericResolver {
	 ...
	 */
	public boolean resolve(final TImplementationArtifact implementationArtifact, final String ownerTargetNamespace, final String ownerName, final int iANumber) {
