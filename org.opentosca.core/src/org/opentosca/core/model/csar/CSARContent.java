...
import org.opentosca.core.common.jpa.PathConverter;
import org.opentosca.core.model.AbstractArtifact;
import org.opentosca.core.model.AbstractDirectory;
import org.opentosca.core.model.AbstractFile;
import org.opentosca.core.model.CSARArtifact;
import org.opentosca.core.model.CSARDirectory;
import org.opentosca.core.model.IBrowseable;
...
/**
 * Represents the meta data of a CSAR and makes the content the CSAR available.
 * It provides structured access to all files and directories of the CSAR. For
 * CSAR browsing this represents the CSAR root. Access to information contained
 * in the TOSCA meta file of the CSAR, e.g. the author. Additionally, it
 * resolves artifact references respectively gives access to the artifact
 * content.
 */
...
public class CSARContent implements IBrowseable {
	 ...
	 *            CSAR.
	 */
	public CSARContent(final CSARID csarID, final Set<Path> directories, final Map<Path, String> fileToStorageProviderIDMap, final TOSCAMetaFile toscaMetaFile) {
	 ...
	 *             artifact is not supported.
	 */
	public AbstractArtifact resolveArtifactReference(final String artifactReference, final Set<String> includePatterns, final Set<String> excludePatterns) throws UserException, SystemException {
