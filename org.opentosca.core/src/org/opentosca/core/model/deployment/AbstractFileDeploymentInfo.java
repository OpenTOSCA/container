...
public abstract class AbstractFileDeploymentInfo extends AbstractDeploymentInfo {
	...
	/**
	 * Counts the number of deployment / undeployment attempts. It will be
	 * incremented by one on every deployment / undeployment attempt. If a file
	 * is deployed and will be now undeployed it will be reseted to 0.
	 */
	@Column(name = "Attempt")
