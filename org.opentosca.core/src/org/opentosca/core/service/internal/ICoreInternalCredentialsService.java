...
/**
 *
 * This interface of the Core Internal Credentials Service defines methods for
 * storing, getting and deleting credentials, checking if credentials are set in
 * a storage provider, setting credentials in a storage provider, getting the
 * name of the credentials identity and key of a storage provider, getting all
