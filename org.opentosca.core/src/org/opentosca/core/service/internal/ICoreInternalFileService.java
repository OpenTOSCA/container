...
/**
 * This interface of the Core Internal File Service defines methods for storing,
 * getting, moving and deleting CSAR files, moving files or directories
 * contained in CSAR files, getting available and ready storage providers,
 * getting and setting the active storage provider, getting the default storage
 * provider.
 *
 * @see CSARContent
 */
public interface ICoreInternalFileService {
	 ...
	 * <br />
	 * Notes:<br />
	 * 1) After the start of the Container no active storage provider is
	 * set.<br />
