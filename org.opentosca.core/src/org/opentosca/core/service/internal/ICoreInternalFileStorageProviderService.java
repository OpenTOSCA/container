...
/**
 * This interface of a storage provider provides methods for getting the ID and
 * name of the storage provider, checking if the storage provider is ready,
 * storing, getting and deleting files on the storage provider, getting the size
 * of files on the storage provider, managing credentials of the storage
 * provider and getting the storage provider-specific identity and key names of
 * credentials.
 */
