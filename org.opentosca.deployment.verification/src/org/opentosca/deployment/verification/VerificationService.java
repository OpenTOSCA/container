...
public class VerificationService {
    ...
    public void runAfterPlan(final CSARID csarId, final String correlationId) {
        ...
        logger.info("Trigger verification after plan has been finished; correlation_id={}, csar={}", correlationId,
            csarId);
     ...
     */
    public Verification run(final CSARID csarId, final ServiceTemplateInstance serviceTemplateInstance) {
