...
public interface IIAEnginePluginService {
	 ...
	 */
	public URI deployImplementationArtifact(CSARID csarID, QName nodeTypeImpl, QName artifactType, Document artifactContent, Document properties, List<TPropertyConstraint> propertyConstraints, List<AbstractArtifact> artifacts, List<String> requiredFeatures);
