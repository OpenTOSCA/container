...
public class NodeInstanceDAO extends AbstractDAO {
	...
	public void setProperties(NodeInstance nodeInstance, Document properties) {
		...
		NodeInstanceDAO.LOG.debug("Invoke of saving nodeInstance: " + nodeInstance.getNodeInstanceID()
	...
	public List<NodeInstance> getNodeInstances(URI serviceInstanceID, QName nodeTemplateID, String nodeTemplateName,
			URI nodeInstanceID) {
		this.init();
		...
		if (serviceInstanceID != null) {
			internalServiceInstanceID = IdConverter.serviceInstanceUriToID(serviceInstanceID);
		}
		
		// Set Parameters for the Query
		getNodeInstancesQuery.setParameter("internalID", internalID);
		getNodeInstancesQuery.setParameter("nodeTemplateID", ((nodeTemplateID != null) ? nodeTemplateID.toString()
				: null));
