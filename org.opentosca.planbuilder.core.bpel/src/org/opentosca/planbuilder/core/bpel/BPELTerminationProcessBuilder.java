...
public class BPELTerminationProcessBuilder extends AbstractTerminationPlanBuilder {
	...
	public BPELPlan buildPlan(final String csarName, final AbstractDefinitions definitions,
		...
		for (final AbstractServiceTemplate serviceTemplate : definitions.getServiceTemplates()) {
			...
			if (namespace.equals(serviceTemplateId.getNamespaceURI())
				...
				final AbstractPlan newAbstractTerminationPlan = this
						.generateTOG(new QName(processNamespace, processName).toString(), definitions, serviceTemplate);

				BPELPlan newTerminationPlan = this.planHandler.createEmptyBPELPlan(processNamespace, processName,
	 ...
	 *
	 * @param plan
	 *            the plan to execute the plugins on
	 * @param serviceTemplate
	 *            the serviceTemplate the plan belongs to
	 * @param propMap
	 *            a PropertyMapping from NodeTemplate to Properties to BPELVariables
	 */
