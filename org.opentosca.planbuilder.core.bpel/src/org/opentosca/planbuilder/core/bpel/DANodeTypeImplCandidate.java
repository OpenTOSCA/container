...
/**
 * <p>
 * This Class represents a Mapping of DA's of an Implementation Plugins which
 * can handle that with matching InfrastructureNode
 * </p>
 * 
...
class DANodeTypeImplCandidate {
	 ...
	 * @param plugin
	 *            the PrePhaseDAPlugin which can deploy the DA unto the given
	 *            NodeTemplate
	 */
	 ...
	 * 
	 * @return true if all DA's of the NodeTypeImplementation can be deployed, else
	 *         false
	 */
	boolean isValid() {
