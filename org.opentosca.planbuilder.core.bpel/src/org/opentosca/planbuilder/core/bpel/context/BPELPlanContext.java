...
public class BPELPlanContext implements PlanContext {
     ...
     */
    public BPELPlanContext(BPELScopeActivity templateBuildPlan, PropertyMap map,
    ...
    public BPELPlanContext createContext(AbstractNodeTemplate nodeTemplate) {
	...
	BPELPlanContext context = new BPELPlanContext(this.templateBuildPlan, this.propertyMap, this.serviceTemplate);
