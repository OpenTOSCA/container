...
public class BPELScopeHandler {
	 ...
	 *            the partnerLinkType which must be already set in the BuildPlan of
	 *            the TemplateBuildPlan
	 * @param myRole
	...
	/**
	 * Connects two TemplateBuildPlans (which are basically bpel scopes) with the
	 * given link
	 *
	 * @param source
	 *            the TemplateBuildPlan which should be a source of the link
	 * @param target
	 *            the TemplateBuildPlan which should be a target of the link
	 * @param linkName
	 *            the name of the link used to connect the two templates
	 * @return true if connections between templates was sucessfully created, else
	 *         false
	 */
	public boolean connect(BPELScopeActivity source, BPELScopeActivity target, String linkName) {
		BPELScopeHandler.LOG.debug(
				"Trying to connect TemplateBuildPlan {} as source with TemplateBuildPlan {} as target",
				source.getBpelScopeElement().getAttribute("name"), target.getBpelScopeElement().getAttribute("name"));
		boolean check = true;
	...
	/**
	 * Creates a TemplateBuildPlan for the given NodeTemplate connected to the given
	 * BuildPlan
	 *
	 * @param nodeTemplate
	 *            the NodeTemplate the new TemplateBuildPlan should belong to
	 * @param buildPlan
	 *            the BuildPlan the new TemplateBuildPlan should belong to
	 ...
	 *            the RelationshipTemplate the new TemplateBuildPlan should belong
	 *            to
	 * @param buildPlan
	 *            the BuildPlan the new TemplateBuildPlan should belong to
	 * @return a new TemplateBuildPlan skeleton
	 */
	public BPELScopeActivity createTemplateBuildPlan(AbstractRelationshipTemplate relationshipTemplate,
			BPELPlan buildPlan) {
		BPELScopeActivity templatePlan = this.createTemplateBuildPlan(buildPlan);
	 ...
	 *
	 * @param buildPlan
	 *            the BuildPlan the TemplateBuildPlan should belong to
	 * @return a new TemplateBuildPlan skeleton
	 */
	...
	/**
	 * Returns the names of the links declared in the sources element of the given
	 * TemplateBuildPlan
	 *
	 * @param template
	 *            the TemplateBuildPlan to fetch the names from
	 * @return a List of String representing Links inside the sources element of the
	...
	/**
	 * Returns the names of the links declared in the targets element of the given
	 * TemplateBuildPlan
	 *
	 * @param template
	 *            the TemplateBuildPlan to fetch the names from
	 * @return a List of Strings representing Links inside the targets element of
	 ...
	 *
	 * @param string
	 *            a String to convert to valid NCName
	 ...
	 *
	 * @param templatePlan
	 *            the TemplateBuildPlan to get predecessors from
	 ...
	 *
	 * @param templatePlan
	 *            the TemplateBuildPlan whose Successors should be returned
	 ...
	 * @param templatePlan
	 *            a templatePlan
	 * @return a List of Strings with the names of the variables defined inside the
	 *         given templatePlan
	 */
	 ...
	 * @param templateBuildPlan
	 *            the TemplateBuildPlan to check on
	 * @return true if the given TemplateBuildPlan already has a partnerLink with
	 *         the given name, else false
	 */
	...
	/**
	 * Initializes XML Elements of the given TemplateBuildPlan and connects it to
	 * the given BuildPlan
	 *
	 ...
	 *
	 * @param template
	 *            the TemplateBuildPlan to remove its relations
	 */
