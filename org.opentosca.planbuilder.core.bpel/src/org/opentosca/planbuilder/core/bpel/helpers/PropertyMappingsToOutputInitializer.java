...
public class PropertyMappingsToOutputInitializer {
	...
	/**
	 * <p>
	 * This class is a wrapper, which holds a mapping from ServiceTemplate Property,
	 * Template and Template Property
	 * </p>
	 * Copyright 2013 IAAS University of Stuttgart <br>
	 * <br>
	 * 
	...
	private class ServiceTemplatePropertyToPropertyMapping {
		...
		/**
		 * Returns a Template property localName for the given serviceTemplate property
		 * localName
		 * 
		 * @param serviceTemplateLocalName
		 *            a localName of a serviceTemplate Property
	 ...
	 * 
	 * @param definitions
	 *            the Definitions document to look for BoundaryDefinitions for and
	 *            contains the ServiceTemplate the BuildPlan belongs to
	 * @param buildPlan
	 ...
	 * BuildPlan. The literal consists of the mappings given, where the propertyMap
	 * is used identify the propertyVariables inside the buildPlan
	 * 
	 * @param buildPlan
	...
	private String generateCopyFromQueryToOutputAsString(String fromQuery, String toQuery) {
		...
		copyString += "<bpel:to variable=\"output\" part=\"payload\"><bpel:query queryLanguage=\"urn:oasis:names:tc:wsbpel:2.0:sublang:xpath1.0\"><![CDATA["
	...
	/**
	 * Calculates the ServiceTemplate Property to Template Property mappings for the
	 * given ServiceTemplate
	 * 
	...
	/**
	 * Checks whether the given XPath 1.0 Query is referencing multiple NodeTemplate
	 * PropertyElements in the form of fkt(propertyQuery,propertyQuery,..).
	 * 
	 * @param xpathQuery
	 ...
	 * @param xpathExpr
	 *            an XPath Expression
	 * @return a localName when the XPath expression returned exactly one Node, else
	 *         null
	 */
