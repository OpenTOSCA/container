...
public interface IPlanBuilderProvPhaseParamOperationPlugin<T extends PlanContext>
	 ...
	 *            a mapping from operation parameters to tosca property variables
	...
	public boolean handle(T context, AbstractOperation operation, AbstractImplementationArtifact ia,
			Map<AbstractParameter, Variable> param2propertyMapping, Map<AbstractParameter, Variable> param2PropertyOutputMapping, boolean appendToPrePhase);
