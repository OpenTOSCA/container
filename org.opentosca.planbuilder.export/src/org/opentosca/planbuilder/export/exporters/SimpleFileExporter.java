...
public class SimpleFileExporter {
	...
	private void rewriteServices(Set<Mapping> servicesToRewrite, WSDLWriter writer, WSDLReader reader,
	 ...
	 *             is thrown when initializing a TransformerFactory or writing the
	 *             Document fails
	 * @throws FileNotFoundException
	 *             is thrown when the File denoted by the File Object doesn't exist
	 */
