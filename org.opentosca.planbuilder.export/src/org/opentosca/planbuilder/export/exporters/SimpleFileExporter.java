...
public class SimpleFileExporter {
	 ...
	 */
	public boolean export(final URI destination, final BuildPlan buildPlan) throws IOException, JAXBException {
		...
		final ServiceReference<?> servRef = FrameworkUtil.getBundle(this.getClass()).getBundleContext().getServiceReference(IFileAccessService.class.getName());
		final IFileAccessService service = (IFileAccessService) FrameworkUtil.getBundle(this.getClass()).getBundleContext().getService(servRef);
