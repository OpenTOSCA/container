 ...
 *
 */
package org.opentosca.planbuilder.generic.plugin.ec2vmInvoker;

import javax.xml.namespace.QName;
import javax.xml.parsers.ParserConfigurationException;

import org.opentosca.planbuilder.generic.plugin.ec2vmInvoker.handler.Handler;
...
public class Plugin implements IPlanBuilderGenericPlugin {
	...
	@Override
	public String getID() {
		return "OpenTOSCA Generic EC2VM Invoker Plugin v0.1";
	}
