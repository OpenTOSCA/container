...
/**
 * <p>
 * This class implements a TOSCA ImplementationArtifact, in particular an
...
public class ImplementationArtifactImpl extends AbstractImplementationArtifact {
	...
	private TImplementationArtifact artifact;
	private DefinitionsImpl defs;
	private List<AbstractProperties> additionalElements;
	 ...
	 */
	public ImplementationArtifactImpl(TImplementationArtifact artifact, DefinitionsImpl definitions) {
		this.artifact = artifact;
		this.defs = definitions;
		this.additionalElements = new ArrayList<AbstractProperties>();
		this.setUp();
	}
	...
	private void setUp() {
		if (this.artifact.getAny() != null) {
			for (Object obj : this.artifact.getAny()) {
