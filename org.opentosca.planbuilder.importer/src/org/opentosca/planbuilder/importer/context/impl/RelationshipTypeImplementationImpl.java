...
public class RelationshipTypeImplementationImpl extends AbstractRelationshipTypeImplementation {
	 ...
	 */
	public RelationshipTypeImplementationImpl(TRelationshipTypeImplementation relationshipTypeImplementation, DefinitionsImpl definitionsImpl) {
	...
	private void initIas() {
		for (TImplementationArtifact artifact : this.relationshipTypeImpl.getImplementationArtifacts().getImplementationArtifact()) {
	...
	private void initTags() {
		if (this.relationshipTypeImpl.getTags() != null) {
			for (TTag tag : this.relationshipTypeImpl.getTags().getTag()) {
	...
	public List<String> getRequiredContainerFeatures() {
		...
		for (TRequiredContainerFeature feature : this.relationshipTypeImpl.getRequiredContainerFeatures().getRequiredContainerFeature()) {
