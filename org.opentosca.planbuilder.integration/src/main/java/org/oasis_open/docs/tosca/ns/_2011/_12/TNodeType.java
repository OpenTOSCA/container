...
@XmlType(name = "tNodeType",
  propOrder = {"requirementDefinitions", "capabilityDefinitions", "instanceStates", "interfaces"})
public class TNodeType extends TEntityType {
   ...
   */
  public void setRequirementDefinitions(final TNodeType.RequirementDefinitions value) {
   ...
   */
  public void setCapabilityDefinitions(final TNodeType.CapabilityDefinitions value) {
   ...
   */
  public void setInterfaces(final TNodeType.Interfaces value) {
  ...
  public static class CapabilityDefinitions {
     ...
     * there is not a <CODE>set</CODE> method for the capabilityDefinition property.
     *
     * <p>
    ...
    public List<TCapabilityDefinition> getCapabilityDefinition() {
      if (this.capabilityDefinition == null) {
        this.capabilityDefinition = new ArrayList<>();
      }
  ...
  public static class RequirementDefinitions {
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any
     * modification you make to the returned list will be present inside the JAXB object. This is why
     * there is not a <CODE>set</CODE> method for the requirementDefinition property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     *
    ...
    public List<TRequirementDefinition> getRequirementDefinition() {
      if (this.requirementDefinition == null) {
        this.requirementDefinition = new ArrayList<>();
      }
