...
import org.opentosca.planbuilder.bpmn4tosca.BPMN4ToscaPlanBuilder;
...
public abstract class AbstractImporter {
	...
	public List<AbstractPlan> buildPlans(AbstractDefinitions defs, String csarName) {
		...
		AbstractPlanBuilder bpmn4toscaPlanBuilder = new BPMN4ToscaPlanBuilder();
		...
		plans.addAll(bpmn4toscaPlanBuilder.buildPlans(csarName, defs));
		return plans;
	}
