...
public abstract class AbstractRelationshipTemplate extends AbstractEntityTemplate {
  ...
  /**
   * Returns the AbstractNodeTemplate representing the NodeTemplate which is the source of this
   * RelationshipTemplate
   *
   * @return an AbstractNodeTemplate representing the source NodeTemplate of this RelationshipTemplate
   */
  public abstract AbstractNodeTemplate getSource();

  /**
   * Returns the Requirement which is referenced by this Relationship Template.
   *
   * @return an AbstractRequirements object, or null if this Relationship Template references a Node
   * Template as Source instead
   */
  public abstract AbstractRequirement getSourceRequirement();

  /**
   * Returns the AbstractNodeTemplate representing the NodeTemplate which is the target of this
   * RelationshipTemplate
   *
   * @return an AbstractNodeTemplate representing the taret NodeTemplate of this RelationshipTemplate
   */
   ...
   *
   * @return an AbstractCapability object, or null if this Relationship Template references a Node
   * Template as Target instead.
   */
   ...
   *
   * @return a String containing the Name of this AbstractRelationshipTemplate, if not declared null
   */
