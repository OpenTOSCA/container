 ...
 * 2.0 BuildPlans für OpenTOSCA</a> and enforces those concepts by defining
...
public class TemplateBuildPlan {
	 ...
	 */
	public void setBpelScopeElement(Element bpelScopeElement) {
	 ...
	 */
	public void setBpelSourcesElement(Element bpelSourcesElement) {
	 ...
	 */
	public void setBpelTargetsElement(Element bpelTargetsElement) {
	 ...
	 */
	public void setBpelVariablesElement(Element bpelVariablesElement) {
	 ...
	 */
	public void setBpelPartnerLinks(Element bpelPartnerLinks) {
	...
	/**
	 * Gets the BPEL Sequence element which is the PrePhase of this
	 * TemplateBuildPlan
	 * 
	 * @return a DOM Element
	 */
	...
	/**
	 * Set the BPEL Sequence element which is the PrePhase of this
	 * TemplateBuildPlan
	 * 
	 * @param bpelSequencePrePhaseElement a DOM Element
	 */
	public void setBpelSequencePrePhaseElement(Element bpelSequencePrePhaseElement) {
		this.bpelSequencePrePhaseElement = bpelSequencePrePhaseElement;
	}
	
	/**
	 * Gets the BPEL Sequence element which is the ProvisioningPhase of this
	 * TemplateBuildPlan
	 * 
	 * @return a DOM Element
	 */
	...
	/**
	 * Set the BPEL Sequence element which is the ProvisioningPhase of this
	 * TemplateBuildPlan
	 * 
	 * @param bpelSequenceProvisioningPhaseElement a DOM Element
	 */
	public void setBpelSequenceProvisioningPhaseElement(Element bpelSequenceProvisioningPhaseElement) {
		this.bpelSequenceProvisioningPhaseElement = bpelSequenceProvisioningPhaseElement;
	}
	
	/**
	 * Gets the BPEL Sequence element which is the PostPhase of this
	 * TemplateBuildPlan
	 * 
	 * @return a DOM Element
	 */
	...
	/**
	 * Sets the BPEL Sequence element which is the PostPhase of this
	 * TemplateBuildPlan
	 * 
	 * @param bpelSequencePostPhaseElement a DOM Element
	 */
	public void setBpelSequencePostPhaseElement(Element bpelSequencePostPhaseElement) {
	 ...
	 * 
	 * @return an AbstractNodeTemplate, else null if this is a TemplateBuildPlan
	 *         for a RelationshipTemplate
	 */
	 ...
	 * 
	 * @return an AbstractRelationshipTemplate, else null if this is a
	 *         TemplateBuildPlan for a RelationshipTemplate
	 */
	 ...
	 */
	public void setRelationshipTemplate(AbstractRelationshipTemplate relationshipTemplate) {
	 ...
	 */
	public void setBpelCorrelationSets(Element bpelCorrelationSets) {
