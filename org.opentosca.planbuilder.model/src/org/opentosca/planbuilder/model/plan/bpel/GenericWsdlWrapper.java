...
/**
 * <p>
 * This class represents a WSDL v1.1. This class is mainly used for the BuildPlan. It uses a
 * internal fragmented WSDL File and allows to add declarations at defined points. The WSDL declares
 * a single PortType for invoking the BuildPlan and second for callback. Both have a single one-way
 * operation defined. With the given operations of this class, the messages can have additional
 * elements defined, which can be used by the plugins to fetch data outside of the TopoloyTemplate
 * scope.
 * </p>
