...
public class BPELVinothekPlugin extends VinothekPlugin<BPELPlanContext> {
	...
	private AbstractNodeTypeImplementation selectNodeTypeImplementation(BPELPlanContext templateContext) {
		...
		for (AbstractNodeTypeImplementation nodeImpl : nodeTemplate.getImplementations()) {
			...
			List<AbstractImplementationArtifact> iasForInterfaces = this
					.getIAsForLifecycleInterface(this.getIAsForInterfaces(nodeImpl.getImplementationArtifacts()));
			List<AbstractImplementationArtifact> iasForOperations = this
					.getIAsForLifecycleInterface(this.getIAsForOperations(nodeImpl.getImplementationArtifacts()));
