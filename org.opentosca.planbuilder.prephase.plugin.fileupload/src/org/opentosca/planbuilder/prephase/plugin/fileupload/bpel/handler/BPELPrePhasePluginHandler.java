...
public class BPELPrePhasePluginHandler {
	 ...
	 * @param artifactName  the name of the artifact, where the references originate
	 *                      from
	 * @param infraTemplate a NodeTemplate which is a InfrastructureNode to deploy
	 *                      the AbstractReferences on
	...
	private boolean handle(final BPELPlanContext templateContext, final List<AbstractArtifactReference> refs,
		...
		for (final String vmLoginName : org.opentosca.container.core.tosca.convention.Utils
		...
		for (final String vmLoginPassword : org.opentosca.container.core.tosca.convention.Utils
