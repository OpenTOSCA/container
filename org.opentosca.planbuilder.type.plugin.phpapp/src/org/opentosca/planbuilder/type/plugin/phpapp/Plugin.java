 ...
 *
 */
package org.opentosca.planbuilder.type.plugin.phpapp;
...
import org.opentosca.planbuilder.type.plugin.phpapp.handler.Handler;
...
public class Plugin implements IPlanBuilderTypePlugin {
	...
	public Plugin() {
		try {
			...
			LOG.error("couldn't load internal handler",e);
		}
	}

	@Override
	public String getID() {
		return "OpenTOSCA PlanBuilder Type Plugin PHP Application";
	}
