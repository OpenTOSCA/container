...
public class EmptyPropertyToInputHandler {
    ...
    public EmptyPropertyToInputHandler(BPELScopeBuilder scopeBuilder) {
        this.scopeBuilder = scopeBuilder;
    }

    /**
     * Adds an element to the plan input with the given namen and assign at runtime the value to the given variable
     *
