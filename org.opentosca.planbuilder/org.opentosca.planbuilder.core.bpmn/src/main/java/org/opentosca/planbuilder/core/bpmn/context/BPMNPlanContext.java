...
public class BPMNPlanContext extends PlanContext {
    ...
    public BPMNPlanContext(BPMNPlan buildPlan, BPMNScope bpmnScope, TServiceTemplate serviceTemplate, String serviceInstanceUrl, String serviceInstanceID, String serviceTemplateUrl, String planInstanceUrl, Csar csar) {
        super(buildPlan, serviceTemplate, null, null, serviceInstanceUrl, serviceInstanceID, serviceTemplateUrl, planInstanceUrl, csar);
