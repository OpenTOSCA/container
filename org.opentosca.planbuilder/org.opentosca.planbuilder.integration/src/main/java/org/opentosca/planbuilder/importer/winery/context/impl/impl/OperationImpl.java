...
public class OperationImpl extends AbstractOperation {
    ...
    private final org.eclipse.winery.model.tosca.TOperation operation;
     ...
     */
    public OperationImpl(final DefinitionsImpl defs, final InterfaceImpl iface, final org.eclipse.winery.model.tosca.TOperation operation) {
        this.defs = defs;
        this.iface = iface;
