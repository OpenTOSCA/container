 ...
 */
public abstract class DockerContainerBPMNTypePlugin<T extends PlanContext> implements IPlanBuilderBPMNTypePlugin<T>,
    IPlanBuilderBPMNTypePlugin.NodeDependencyInformationInterface {

    private static final String PLUGIN_ID = "BPMN OpenTOSCA PlanBuilder Type Plugin DockerContainer";
    ...
    @Override
    public String getID() {
        return DockerContainerBPMNTypePlugin.PLUGIN_ID;
    }
}
