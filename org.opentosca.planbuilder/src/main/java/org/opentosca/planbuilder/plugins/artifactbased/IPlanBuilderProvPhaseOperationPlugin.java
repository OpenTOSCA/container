 ...
 * Provisioning trough TOSCA Operations on Node-/RelationshipTypes
 * </p>
...
public interface IPlanBuilderProvPhaseOperationPlugin<T extends PlanContext> extends IPlanBuilderPlugin {
    ...
    /**
     * This method is used determine whether the Plugin can handle Operations which are implemented by
     * an IA with the given ArtifactType
     *
     * @param operationArtifactType the Type of the IA which implements a TOSCA Operation
     * @return true iff the plugin can handle Operations that are implemented by IA of the given
     *         ArtifactType
     */
