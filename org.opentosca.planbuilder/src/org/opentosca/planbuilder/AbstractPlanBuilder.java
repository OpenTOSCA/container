...
public abstract class AbstractPlanBuilder {
	 ...
	 *         NodeTemplate, else false
	 */
	public IPlanBuilderPolicyAwareTypePlugin findPolicyAwareTypePlugin(AbstractNodeTemplate nodeTemplate) {
		for (IPlanBuilderPolicyAwareTypePlugin plugin : this.pluginRegistry.getPolicyAwareTypePlugins()) {
