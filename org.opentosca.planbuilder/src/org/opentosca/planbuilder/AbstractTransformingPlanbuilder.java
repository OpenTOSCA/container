...
public abstract class AbstractTransformingPlanbuilder extends AbstractPlanBuilder {
    ...
    public AbstractPlan generateTFOG(String sourceCsarName, AbstractDefinitions sourceDefinitions,
        ...
        AbstractTransformationPlan transPlan =
            this.mergeTermAndStartPlans("transformationPlan_" + termPlan.getServiceTemplate().getId() + "_to_"
                + startPlan.getServiceTemplate().getId(), PlanType.TRANSFORMATION, termPlan, startPlan);
