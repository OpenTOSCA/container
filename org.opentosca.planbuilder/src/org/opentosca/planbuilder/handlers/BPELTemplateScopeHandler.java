...
public class BPELTemplateScopeHandler {
	...
	public void initializeXMLElements(TemplateBuildPlan newTemplateBuildPlan, BuildPlan buildPlan) {
		...
		newTemplateBuildPlan.setBpelScopeElement(newTemplateBuildPlan.getBpelDocument().createElementNS(BuildPlan.bpelNamespace, "scope"));
		// info: append to flow element of the buildplan
		newTemplateBuildPlan.getBuildPlan().getBpelMainFlowElement().appendChild(newTemplateBuildPlan.getBpelScopeElement());
		
		// initialize bpelTargetsElement and append to scope
		newTemplateBuildPlan.setBpelTargetsElement(newTemplateBuildPlan.getBpelDocument().createElementNS(BuildPlan.bpelNamespace, "targets"));
		...
		newTemplateBuildPlan.setBpelSourcesElement(newTemplateBuildPlan.getBpelDocument().createElementNS(BuildPlan.bpelNamespace, "sources"));
		...
		newTemplateBuildPlan.setBpelPartnerLinks(newTemplateBuildPlan.getBpelDocument().createElementNS(BuildPlan.bpelNamespace, "partnerLinks"));
		...
		newTemplateBuildPlan.setBpelVariablesElement(newTemplateBuildPlan.getBpelDocument().createElementNS(BuildPlan.bpelNamespace, "variables"));
		...
		newTemplateBuildPlan.setBpelCorrelationSets(newTemplateBuildPlan.getBpelDocument().createElementNS(BuildPlan.bpelNamespace, "correlationSets"));
		...
		newTemplateBuildPlan.setBpelMainSequenceElement(newTemplateBuildPlan.getBpelDocument().createElementNS(BuildPlan.bpelNamespace, "sequence"));
		...
		newTemplateBuildPlan.setBpelSequencePrePhaseElement(newTemplateBuildPlan.getBpelDocument().createElementNS(BuildPlan.bpelNamespace, "sequence"));
		newTemplateBuildPlan.getBpelMainSequenceElement().appendChild(newTemplateBuildPlan.getBpelSequencePrePhaseElement());
		
		// initialize bpelSequenceProvisioningPhaseElement and append to
		// mainsequence
		newTemplateBuildPlan.setBpelSequenceProvisioningPhaseElement(newTemplateBuildPlan.getBpelDocument().createElementNS(BuildPlan.bpelNamespace, "sequence"));
		newTemplateBuildPlan.getBpelMainSequenceElement().appendChild(newTemplateBuildPlan.getBpelSequenceProvisioningPhaseElement());
		
		// initialize bpelSequencePostPhaseElement and append to scope
		newTemplateBuildPlan.setBpelSequencePostPhaseElement(newTemplateBuildPlan.getBpelDocument().createElementNS(BuildPlan.bpelNamespace, "sequence"));
		newTemplateBuildPlan.getBpelMainSequenceElement().appendChild(newTemplateBuildPlan.getBpelSequencePostPhaseElement());
	 ...
	 * @param partnerLinkType the partnerLinkType which must be already set in
	 *            the BuildPlan of the TemplateBuildPlan
	...
	public boolean addPartnerLink(String partnerLinkName, QName partnerLinkType, String myRole, String partnerRole, boolean initializePartnerRole, TemplateBuildPlan templateBuildPlan) {
		BPELTemplateScopeHandler.LOG.debug("Trying to add partnerLink {} with partnerLinkType {}, myRole {}, partnerRole {} and initializePartnerRole {} on TemplateBuildPlan {}", partnerLinkName, partnerLinkType.toString(), myRole, partnerRole, String.valueOf(initializePartnerRole), templateBuildPlan.getBpelScopeElement().getAttribute("name"));
		...
		Element partnerLinkElement = templateBuildPlan.getBpelDocument().createElementNS(BuildPlan.bpelNamespace, "partnerLink");
	 ...
	 * @param templateBuildPlan the TemplateBuildPlan to add the correlationSet
	 *            to
	 * @return true if adding CorrelationSet was successful, else false
	 */
	public boolean addCorrelationSet(String correlationSetName, String propertyName, TemplateBuildPlan templateBuildPlan) {
		BPELTemplateScopeHandler.LOG.debug("Trying to add correlationSet {} with property {} to templateBuildPlan {}", correlationSetName, propertyName, templateBuildPlan.getBpelScopeElement().getAttribute("name"));
		...
		Element correlationSetElement = templateBuildPlan.getBpelDocument().createElementNS(BuildPlan.bpelNamespace, "correlationSet");
	...
	private boolean hasCorrelationSet(String correlationSetName, TemplateBuildPlan templateBuildPlan) {
		return Utils.hasChildElementWithAttribute(templateBuildPlan.getBpelCorrelationSets(), "name", correlationSetName);
	}
	...
	public boolean addSource(String linkName, TemplateBuildPlan templateBuildPlan) {
		BPELTemplateScopeHandler.LOG.debug("Trying to add link {} as source to TemplateBuildPlan {}", linkName, templateBuildPlan.getBpelScopeElement().getAttribute("name"));
	 ...
	 */
	public boolean addVariable(String name, BuildPlan.VariableType variableType, QName declarationId, TemplateBuildPlan templateBuildPlan) {
		BPELTemplateScopeHandler.LOG.debug("Trying to add variable {} with of type {} and XML Schematype {} to TemplateBuildPlan {}", name, variableType, declarationId.toString(), templateBuildPlan.getBpelScopeElement().getAttribute("name"));
		...
		Element variableElement = templateBuildPlan.getBpelDocument().createElementNS(BuildPlan.bpelNamespace, "variable");
	...
	public boolean addTarget(String linkName, TemplateBuildPlan templateBuildPlan) {
		BPELTemplateScopeHandler.LOG.debug("Trying to add link {} as target to TemplateBuildPlan {}", linkName, templateBuildPlan.getBpelScopeElement().getAttribute("name"));
	 ...
	 * 
	 * @param template the TemplateBuildPlan for that all source relations have
	 *            to be removed
	 */
	 ...
	 * Removes all links which use the given TemplateBuildPlan as source
	 * 
	 * @param template the TemplateBuildPlan for that all target relations have
	 *            to be removed
	 */
