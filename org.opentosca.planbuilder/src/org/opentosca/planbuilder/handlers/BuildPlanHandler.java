...
public class BuildPlanHandler {
	...
	/**
	 * Creates a BuildPlan with an empty skeleton for the given ServiceTemplate
	 * 
	 * @param serviceTemplate the ServiceTemplate to generate BuildPlan Skeleton
	 *            for
	 * @return an empty BuildPlan Skeleton
	 */
	public BuildPlan createBuildPlan(AbstractServiceTemplate serviceTemplate) {
		...
		String processNamespace = "ba.example";
	 ...
	 * @param buildPlan the BuildPlan to add the propertyVariable to
	...
	public boolean addPropertyVariable(String name, BuildPlan buildPlan) {
		return this.bpelProcessHandler.addVariable("prop_" + name, BuildPlan.VariableType.TYPE, new QName("http://www.w3.org/2001/XMLSchema", "string", "xsd"), buildPlan);
	}
