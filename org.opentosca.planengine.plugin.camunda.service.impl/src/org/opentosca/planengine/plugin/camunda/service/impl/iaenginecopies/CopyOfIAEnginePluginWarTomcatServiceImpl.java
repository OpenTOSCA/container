...
public class CopyOfIAEnginePluginWarTomcatServiceImpl {
	...
	private String deploy(CSARID csarID, File warFile) {
		...
		if (isRunning()) {
			...
			try {
				...
				String uri = CopyOfIAEnginePluginWarTomcatServiceImpl.URL + "/manager/text/deploy?update=true&path=" + deployPath;
				...
				HttpResponse httpResponse = httpService.Put(uri, uploadEntity, CopyOfIAEnginePluginWarTomcatServiceImpl.USERNAME, CopyOfIAEnginePluginWarTomcatServiceImpl.PASSWORD);
	...
	private boolean isRunning() {
		...
		try {
			httpResponse = httpService.Get(url, CopyOfIAEnginePluginWarTomcatServiceImpl.USERNAME, CopyOfIAEnginePluginWarTomcatServiceImpl.PASSWORD);
