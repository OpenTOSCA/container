package org.opentosca.siengine.api.soaphttp;
...
import org.opentosca.siengine.api.soaphttp.route.Route;
...
public class EndpointServiceHandler {
	...
	public void bindEndpointService(ICoreEndpointService endpointService) {
		if (endpointService != null) {
			...
			EndpointServiceHandler.LOG.debug("Storing the Service-Invoker endpoint: {} via EndpointService...", Route.ENDPOINT);
			...
			// Stores the Service Invoker endpoint in the endpointDB. "***",
			// cause the SI-endpoint is csar independence.
