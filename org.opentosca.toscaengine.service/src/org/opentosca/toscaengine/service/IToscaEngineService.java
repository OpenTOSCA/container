...
public interface IToscaEngineService {
	 ...
	 * 
	 * @param csarID
	 *            CSAR ID in which the ServiceTemplate is stored.
	 ...
	 * 
	 * @param csarID
	 *            of the CSAR containing the ServiceTemplate.
	 ...
	 * 
	 * @param csarID
	 *            of the CSAR containing the NodeType.
	 * @param nodeTypeID
	 *            of the NodeType to check.
	 * @param InterfaceName
	 *            of the NodeType to check.
	 * @param operationName
	 *            of the NodeType to check.
	 ...
	 *            of the RelationshipType to check.
	 * @param InterfaceName
	 *            of the RelationshipType to check.
	 * @param operationName
	 *            of the RelationshipType to check.
	 ...
	 * 
	 * @param csarID
	 *            of the CSAR containing the RelationshipType.
	 * @param relationshipTypeID
	 *            of the RelationshipType to check.
	 * @param InterfaceName
	 *            of the RelationshipType to check.
	 ...
	 *            of the CSAR containing the NodeTypeImplementation.
	 * @param relationshipTypeID
	 *            of the RelationshipTypeImplementation.
	 ...
	 * 
	 * @param csarID
	 *            of the CSAR containing the RelationshipTypeImplementation.
	 * @param relationshipTypeImplementationID
	 *            of the RelationshipTypeImplementation containing the
	 *            ImplementationArtifact.
	 * @param implementationArtifactName
	 *            of the ImplementationArtifact
	 * @return QName of the ArtifactType or null in case of an error
	 ...
	 *            of the CSAR.
	 * @param reference
	 *            of which the xml should be returned.
	 ...
	 *            of the operation.
	 * @param operationName
	 *            of which the parameters should be returned.
	 ...
	 *            of the operation.
	 * @param operation
	 *            name of which the parameters should be returned.
	 ...
	 * @param reference
	 *            the QName reference to a NodeTemplate or
	 *            NodeTypeImplementation.
	 * @param deploymentArtifactName
	 *            the Name of the deploymentArtifact
	 ...
	 *            of the requested ArtifactTemplate.
	 ...
	 *            of the CSAR containing the ArtifactTemplate.
	 * @param serviceTemplateID
	 *            of the ServiceTemplate containing the NodeTemplate.
	 * @param nodeTemplateID
	 *            the String value of the attribute ID of the NodeTemplate.
	 ...
	 *            the String value of the attribute ID of the
	 ...
	 *            of the CSAR containing the ArtifactTemplate.
	 * @param nodeTypeID
	 *            containing the PropertiesDefinition
	 * 
	 ...
	 *            of the CSAR containing the ArtifactTemplate.
	 * @param serviceTemplateID
	 *            of the ServiceTemplate containing the RelationshipTemplate.
	 * @param relationshipTemplateID
	 *            the String value of the attribute ID of the
	 *            RelationshipTemplate.
	 * @return Document containing the Properties (may be empty) or null in case
	 ...
	 * 
	 * @param csarID
	 *            of the CSAR containing the NodeTemplate.
	 * @param nodeTemplateID
	 *            QName of the nodeTemplate (ID)
	 ...
	 *            of the CSAR containing the NodeTypeImplementation.
	 * @param nodeTypeImplementationID
	 *            QName of the nodeTypeImplementation (ID)
	 * @return Resolved Artifacts containing all resolvedArtifacts
	 */
	 ...
	 *            of the CSAR containing the NodeTypeImplementation.
	 * @param relationshipTypeImplementationID
	 *            QName of the relationshipTypeImplementation (ID)
	 * @return Resolved Artifacts containing all resolvedArtifacts
	 */
	 ...
	 * 
	 * @param csarID
	 *            the ID of a CSAR which stored informations shall be deleted.
	 * @return true for success, false for one or more errors
	 */
	 ...
	 * 
	 * @param csarID
	 *            of the CSAR containing the reference
	 * @param reference
	 *            the qualifiedName of the reference of which the name attribute
	 *            should be retrieved
	 ...
	 *            of the ServiceTemplate containing the NodeTemplate.
	 * @param nodeTemplateID
	 *            the String value of the attribute ID (=local part) of the
	 *            NodeTemplate. (Namespace is internally retrieved from
	 *            serviceTemplateID)
	 ...
	 * 
	 * @param csar
	 *            CSAR in which the plan is
	 * @param planId
	 *            reference to the TOSCA Plan element
	 ...
	 * 
	 * @param nodeTypeImplementationId
	 *            a QName of a Node Type Implementation
	 ...
	 *
	 * @param csarId
	 *            the CSAR the ServiceTemplate belongs to
	 * @param serviceTemplateId
	 *            a QName denoting a ServiceTemplate
