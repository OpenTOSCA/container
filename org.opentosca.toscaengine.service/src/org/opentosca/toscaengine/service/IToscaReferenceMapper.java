...
public interface IToscaReferenceMapper {
    ...
    public void storeInterfaceNameForPlan(CSARID csarID, QName planID, String interfaceName);
    ...
    public void setBoundaryOperationForCSARIDPlan(CSARID csarID, QName planID, String opName);
