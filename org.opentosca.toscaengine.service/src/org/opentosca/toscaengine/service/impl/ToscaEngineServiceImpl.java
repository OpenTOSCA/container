...
public class ToscaEngineServiceImpl implements IToscaEngineService {
	...
	public List<QName> getReferencedNodeTypesOfAServiceTemplate(CSARID csarID, QName serviceTemplateID) {
		...
		TServiceTemplate serviceTemplate = (TServiceTemplate) ToscaEngineServiceImpl.toscaReferenceMapper
	 ...
	 */
	@Override
	public boolean hasOperationOfANodeTypeSpecifiedInputParams(CSARID csarID, QName nodeTypeID, String interfaceName,
			String operationName) {

		for (QName nodeTypeHierarchyMember : this.getNodeTypeHierachy(csarID, nodeTypeID)) {

			TNodeType nodeType = (TNodeType) ToscaEngineServiceImpl.toscaReferenceMapper.getJAXBReference(csarID,
	 ...
	 */
	@Override
	public boolean hasOperationOfARelationshipTypeSpecifiedInputParams(CSARID csarID, QName relationshipTypeID,
			String interfaceName, String operationName) {

		TRelationshipType relationshipType = (TRelationshipType) ToscaEngineServiceImpl.toscaReferenceMapper
				.getJAXBReference(csarID, relationshipTypeID);
	 ...
	 */
	@Override
	public boolean hasOperationOfANodeTypeSpecifiedOutputParams(CSARID csarID, QName nodeTypeID, String interfaceName,
			String operationName) {
	 ...
	 */
	@Override
	public boolean hasOperationOfARelationshipTypeSpecifiedOutputParams(CSARID csarID, QName relationshipTypeID,
			String interfaceName, String operationName) {
	 ...
	 */
	@Override
	public boolean doesInterfaceOfNodeTypeContainOperation(CSARID csarID, QName nodeTypeID, String interfaceName,
			String operationName) {
	 ...
	 */
	@Override
	public boolean doesInterfaceOfRelationshipTypeContainOperation(CSARID csarID, QName relationshipTypeID,
			String interfaceName, String operationName) {
	 ...
	 */
	@Override
	public boolean isOperationOfRelationshipBoundToSourceNode(CSARID csarID, QName relationshipTypeID,
			String interfaceName, String operationName) {
	...
	public List<String> getImplementationArtifactNamesOfNodeTypeImplementation(CSARID csarID,
		...
		for (QName nodeTypeImplHierarchyMember : this.getNodeTypeImplementationTypeHierarchy(csarID,
			...
			TNodeTypeImplementation nodeTypeImplementation = (TNodeTypeImplementation) ToscaEngineServiceImpl.toscaReferenceMapper
					.getJAXBReference(csarID, nodeTypeImplHierarchyMember);

			// if there are ImplementationArtifacts, get the names
			if (nodeTypeImplementation.getImplementationArtifacts() != null) {
				for (TImplementationArtifact implArt : nodeTypeImplementation.getImplementationArtifacts()
	...
	public String getRelatedNodeTemplateID(CSARID csarID, QName serviceTemplateID, String nodeTemplateID,
		...
		List<TEntityTemplate> templateList = serviceTemplate.getTopologyTemplate()
	...
	public List<String> getImplementationArtifactNamesOfRelationshipTypeImplementation(CSARID csarID,
		...
		TRelationshipTypeImplementation relationshipTypeImplementation = (TRelationshipTypeImplementation) ToscaEngineServiceImpl.toscaReferenceMapper
				.getJAXBReference(csarID, relationshipTypeImplementationID);

		// if there are ImplementationArtifacts, get the names
		if (relationshipTypeImplementation.getImplementationArtifacts() != null) {
			for (TImplementationArtifact implArt : relationshipTypeImplementation.getImplementationArtifacts()
					.getImplementationArtifact()) {
				listOfNames.add(implArt.getName());
			}
		}
	...
	public Document getArtifactSpecificContentOfADeploymentArtifact(CSARID csarID, QName reference,
	...
	public List<String> getRequiredContainerFeaturesOfANodeTypeImplementation(CSARID csarID,
		...
		if (nodeTypeImplementation.getRequiredContainerFeatures() != null) {
			for (TRequiredContainerFeature requiredContainerFeature : nodeTypeImplementation
					.getRequiredContainerFeatures().getRequiredContainerFeature()) {
	...
	public QName getArtifactTemplateOfAImplementationArtifactOfARelationshipTypeImplementation(CSARID csarID,
		...
		// get the RelationshipTypeImplementation
		TRelationshipTypeImplementation relationTypeImplementation = (TRelationshipTypeImplementation) ToscaEngineServiceImpl.toscaReferenceMapper
				.getJAXBReference(csarID, relationshipTypeImplementationID);

		// if there are ImplementationArtifacts
		if (relationTypeImplementation.getImplementationArtifacts() != null) {
			for (TImplementationArtifact implArt : relationTypeImplementation.getImplementationArtifacts()
					.getImplementationArtifact()) {
	...
	public Node getReferenceAsNode(CSARID csarID, QName reference) {
		...
		Node artifactTemplateDoc = (Node) ToscaEngineServiceImpl.toscaReferenceMapper.getReferenceAsNode(csarID,
				reference);
	...
	public Document getPropertiesOfAArtifactTemplate(CSARID csarID, QName artifactTemplateID) {
		...
		Object requestedObject = ToscaEngineServiceImpl.toscaReferenceMapper.getJAXBReference(csarID,
				artifactTemplateID);
		...
		if (requestedObject instanceof TArtifactTemplate) {
			...
			if (artifactTemplate.getProperties() != null) {
				...
				if (artifactTemplate.getProperties().getAny() instanceof Element) {
					Document returnDoc = ServiceHandler.xmlSerializerService.getXmlSerializer()
							.elementIntoDocument((Element) artifactTemplate.getProperties().getAny());
	 ...
	 */
	@Override
	public List<TPropertyConstraint> getPropertyConstraintsOfAArtifactTemplate(CSARID csarID,
			QName artifactTemplateID) {
	...
	public List<AbstractArtifact> getArtifactsOfAArtifactTemplate(CSARID csarID, QName artifactTemplateID) {
		...
		if (requestedObject instanceof TArtifactTemplate) {
			...
			if (artifactTemplate.getArtifactReferences() != null) {
				...
				for (TArtifactReference artifactReference : artifactTemplate.getArtifactReferences()
					...
					try {
						AbstractArtifact artifact = csar.resolveArtifactReference(artifactReference.getReference(),
	...
	public QName getRelationshipTypeOfRelationshipTemplate(CSARID csarID, QName serviceTemplateID,
		...
		TRelationshipTemplate relationshipTemplate = (TRelationshipTemplate) ToscaEngineServiceImpl.toscaReferenceMapper
				.getJAXBReference(csarID, RelationshipTemplateReference);
	...
	public Document getPropertiesOfNodeTemplate(CSARID csarID, QName serviceTemplateID, String nodeTemplateID) {
		...
		// get the NodeTypeImplementation
		TNodeTemplate nodeTemplate = (TNodeTemplate) ToscaEngineServiceImpl.toscaReferenceMapper
				.getJAXBReference(csarID, NodeTemplateReference);
	...
	public ResolvedArtifacts getResolvedArtifactsOfRelationshipTypeImplementation(CSARID csarID,
			QName nodeTypeImplementationID) {
		// TODO: add debug logger
		List<ResolvedImplementationArtifact> resolvedIAs = getRelationshipTypeImplResolvedIAs(csarID,
				nodeTypeImplementationID);
	...
	private List<ResolvedDeploymentArtifact> getNodeTemplateResolvedDAs(CSARID csarID, QName nodeTemplateID) {
		...
		for (TDeploymentArtifact deployArt : nodeTemplate.getDeploymentArtifacts().getDeploymentArtifact()) {
			...
			if (deployArt.getArtifactRef() != null) {
				...
				TArtifactTemplate artTemplate = (TArtifactTemplate) ToscaEngineServiceImpl.toscaReferenceMapper
						.getJAXBReference(csarID, deployArt.getArtifactRef());
				...
				artifactSpecificContent = getArtifactSpecificContentOfADeploymentArtifact(csarID, nodeTemplateID,
						deployArt.getName());
	...
	private List<ResolvedDeploymentArtifact> getNodeTypeImplResolvedDAs(CSARID csarID, QName nodeTypeImplementationID) {
		...
		ToscaEngineServiceImpl.LOG
				.debug("Trying to fetch DA of NodeTypeImplementation" + nodeTypeImplementationID.toString());
		...
		if (nodeTypeImplementation.getDeploymentArtifacts() != null) {
			for (TDeploymentArtifact deployArt : nodeTypeImplementation.getDeploymentArtifacts()
				...
				if (deployArt.getArtifactRef() != null) {
					...
					artifactSpecificContent = getArtifactSpecificContentOfADeploymentArtifact(csarID,
	 ...
	 *         empty.
	 */
	private List<ResolvedImplementationArtifact> getNodeTypeImplResolvedIAs(CSARID csarID,
			QName nodeTypeImplementationID) {
		...
		for (TImplementationArtifact implArt : nodeTypeImplementation.getImplementationArtifacts()
			...
			if (implArt.getArtifactRef() != null) {
				...
				artifactSpecificContent = getArtifactSpecificContentOfAImplementationArtifactOfANodeTypeImplementation(
	 ...
	 *         empty.
	 */
	private List<ResolvedImplementationArtifact> getRelationshipTypeImplResolvedIAs(CSARID csarID,
			QName relationshipTypeImplementationID) {
		List<ResolvedImplementationArtifact> resolvedIAs = new ArrayList<ResolvedImplementationArtifact>();
		...
		for (TImplementationArtifact implArt : relationshipTypeImplementation.getImplementationArtifacts()
			...
			if (implArt.getArtifactRef() != null) {
				...
				artifactSpecificContent = getArtifactSpecificContentOfAImplementationArtifactOfARelationshipTypeImplementation(
	...
	public NodeTemplateInstanceCounts getInstanceCountsOfNodeTemplatesByServiceTemplateID(CSARID csarID,
		...
		TServiceTemplate serviceTemplate = (TServiceTemplate) ToscaEngineServiceImpl.toscaReferenceMapper
				.getJAXBReference(csarID, serviceTemplateID);
		List<TEntityTemplate> nodeTemplateOrRelationshipTemplate = serviceTemplate.getTopologyTemplate()
				.getNodeTemplateOrRelationshipTemplate();
	...
	public AbstractArtifact getPlanModelReferenceAbstractArtifact(CSARContent csar, QName planId) {
		...
		QName containingDefinitions = ToscaEngineServiceImpl.toscaReferenceMapper
				.getContainingDefinitionsID(csar.getCSARID(), planId);
		...
		if (null != containingDefinitions) {
			...
			String definitionsLocation = ToscaEngineServiceImpl.toscaReferenceMapper
					.getDefinitionsLocation(csar.getCSARID(), containingDefinitions);

			if (null != definitionsLocation) {

				ToscaEngineServiceImpl.LOG.trace("Definitions path is \"" + definitionsLocation + "\".");

				TPlan plan = (TPlan) ToscaEngineServiceImpl.toscaReferenceMapper.getJAXBReference(csar.getCSARID(),
						planId);
				...
				String absoluteLocation = PathResolver.resolveRelativePath(definitionsLocation,
	...
	public List<QName> getNodeTypeHierachy(CSARID csarID, QName nodeType) {
		...
		TNodeType nodeTypeElement = (TNodeType) ToscaEngineServiceImpl.toscaReferenceMapper.getJAXBReference(csarID,
				nodeType);
	...
	public List<QName> getNodeTypeImplementationTypeHierarchy(CSARID csarID, QName nodeTypeImplementationId) {
		List<QName> qnames = new ArrayList<QName>();
		TNodeTypeImplementation nodeTypeImplElement = (TNodeTypeImplementation) ToscaEngineServiceImpl.toscaReferenceMapper
				.getJAXBReference(csarID, nodeTypeImplementationId);
