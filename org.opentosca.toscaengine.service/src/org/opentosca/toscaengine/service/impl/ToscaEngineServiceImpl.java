...
public class ToscaEngineServiceImpl implements IToscaEngineService {
	...
	public ResolvedArtifacts getResolvedArtifactsOfNodeTypeImplementation(CSARID csarID,
		...
		List<ResolvedImplementationArtifact> resolvedIAs = this.getNodeTypeImplResolvedIAs(csarID,
				nodeTypeImplementationID);
		List<ResolvedDeploymentArtifact> resolvedDAs = this.getNodeTypeImplResolvedDAs(csarID,
				nodeTypeImplementationID);
	...
	public ResolvedArtifacts getResolvedArtifactsOfRelationshipTypeImplementation(CSARID csarID,
		...
		List<ResolvedImplementationArtifact> resolvedIAs = this.getRelationshipTypeImplResolvedIAs(csarID,
				nodeTypeImplementationID);
