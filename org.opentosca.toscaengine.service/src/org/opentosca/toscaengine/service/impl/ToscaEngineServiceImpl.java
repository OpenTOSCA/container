...
public class ToscaEngineServiceImpl implements IToscaEngineService {
	...
	List<ResolvedImplementationArtifact> resolvedIAs = getNodeTypeImplResolvedIAs(csarID,
	    nodeTypeImplementationID);
	List<ResolvedDeploymentArtifact> resolvedDAs = getNodeTypeImplResolvedDAs(csarID,
	    nodeTypeImplementationID);
	...
	for (TImplementationArtifact implArt : nodeTypeImplementation.getImplementationArtifacts()
		...
		artifactSpecificContent = getArtifactSpecificContentOfAImplementationArtifactOfANodeTypeImplementation(csarID,
		    nodeTypeImplementationID, implArt.getName());
		ra.setArtifactSpecificContent(artifactSpecificContent);
	    }
	...
	for (TImplementationArtifact implArt : relationshipTypeImplementation.getImplementationArtifacts()
		...
		artifactSpecificContent = getArtifactSpecificContentOfAImplementationArtifactOfARelationshipTypeImplementation(csarID,
		    relationshipTypeImplementationID, implArt.getName());
		ra.setArtifactSpecificContent(artifactSpecificContent);
	    }
