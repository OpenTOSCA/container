...
/**
 * The PropertiesDefinitionResolver resolves references inside of TOSCA
 * PropertiesDefinitions according to the TOSCA specification wd14. Each found
 ...
 * 
 * Preconditions for resolving a PropertiesDefinition: Definitions has to be
...
public class PropertiesDefinitionResolver extends GenericResolver {
	 ...
	 * PropertiesDefinitions. This constructor sets the ReferenceMapper which
	 * searches for references.
	 * 
	 * @param referenceMapper
	 */
	public PropertiesDefinitionResolver(ReferenceMapper referenceMapper) {
		super(referenceMapper);
	}
	
	/**
	 * Resolves all PropertiesDefinitions inside of a Definitions and stores the
	 * mapping into the ToscaReferenceMapper.
	 * 
	 * @param definitions The Definitions object.
	 * @return true if an error occurred, false if not
	 */
	public boolean resolve(PropertiesDefinition propertiesDefinition) {
