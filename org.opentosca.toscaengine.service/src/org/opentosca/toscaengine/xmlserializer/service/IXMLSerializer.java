package org.opentosca.toscaengine.xmlserializer.service;
...
/**
 * Interface of the XML Serialization for marshaling and unmarshaling objects of
 * the TOSCA universe to the needed JAXB or DOM objects as well as other XML
 * content to DOM objects. Instances of this Interface can be created with the
 * SerializerFactory.
 * 
 * An implementation of this interface provides functionality for processing XML
 * data in files and JAXB objects. Further the Serializer can convert these data
 * to DOM and String representations.
 * 
