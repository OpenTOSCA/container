package org.opentosca.util.fileaccess.service;

import java.io.File;
import java.util.List;

/**
 * Interface that provides methods to access files stored in this File Access
 * Service.<br />
 * <br />
...
public interface IFileAccessService {
	...
	/**
	 * @return File object of a invalid TOSCA meta file (meta file version is
	 *         not "1.0").
	 */
	public File getTOSCAMetaFileInvalid1();
	
	/**
	 * @return File object of a invalid TOSCA meta file (CSAR version is empty,
	 *         Created by is missing).
	 */
	...
	/**
	 * @return File object of a invalid TOSCA meta file (Description is defined,
	 *         but is missing).
	 */
	public File getTOSCAMetaFileInvalid4();
	
	/**
	 * @return File object of a invalid TOSCA meta file (Topology is defined,
	 *         but is empty).
	 */
	public File getTOSCAMetaFileInvalid5();
	
	/**
	 * @return File object of a invalid TOSCA meta file (Entry Definitions is
	 *         defined, but is empty).
	 */
	public File getTOSCAMetaFileInvalid6();
	
	/**
	 * @return File object of a invalid TOSCA meta file (Content-Type in file
	 *         block is invalid).
	 */
	...
	/**
	 * @return File object of a valid TOSCA meta file (with additional attribute
	 *         in block 0 and 2 file blocks).
	 */
	...
	/**
	 * @return Test CSAR for Core File Service test cases (contains no
	 *         Definitions).
	 */
	...
	/**
	 * Creates a new ZIP archive containing the contents of supplied
	 * <code>directory</code>.<br />
	 * Existing archives with the same name will be overwritten.
	 * 
	 * @param directory - absolute path to the directory that content (including
	 *            sub directories) should be zipped
	 ...
	 * @param target - directory where the content of the archive should be
	 *            unpacked
